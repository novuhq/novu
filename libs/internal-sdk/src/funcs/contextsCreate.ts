...
export function contextsCreate(
  ...
  >
> {
  return new APIPromise($do(client, createContextRequestDto, idempotencyKey, options));
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.ContextsControllerCreateContextRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.ContextsControllerCreateContextResponse$inboundSchema, { hdrs: true, key: 'Result' }),
