...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.ChannelEndpointsControllerCreateChannelEndpointRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.ChannelEndpointsControllerCreateChannelEndpointResponse$inboundSchema, {
      hdrs: true,
      key: 'Result',
    }),
