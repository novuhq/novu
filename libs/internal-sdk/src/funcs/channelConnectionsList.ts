...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ChannelConnectionsControllerListChannelConnectionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ChannelConnectionsControllerListChannelConnectionsResponse$inboundSchema, {
      hdrs: true,
      key: 'Result',
    }),
