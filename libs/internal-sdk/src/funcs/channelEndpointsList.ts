...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ChannelEndpointsControllerListChannelEndpointsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ChannelEndpointsControllerListChannelEndpointsResponse$inboundSchema, {
      hdrs: true,
      key: 'Result',
    }),
