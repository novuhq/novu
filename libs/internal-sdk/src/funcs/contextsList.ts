...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ContextsControllerListContextsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ContextsControllerListContextsResponse$inboundSchema, { hdrs: true, key: 'Result' }),
