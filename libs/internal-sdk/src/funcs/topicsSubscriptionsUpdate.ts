...
> {
  ...
  const pathParams = {
    subscriptionIdOrIdentifier: encodeSimple('subscriptionIdOrIdentifier', payload.subscriptionIdOrIdentifier, {
      explode: false,
  ...
  const path = pathToFunc('/v2/topics/{topicKey}/subscriptions/{subscriptionIdOrIdentifier}')(pathParams);
