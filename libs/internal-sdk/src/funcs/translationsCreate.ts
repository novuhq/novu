...
export function translationsCreate(
  ...
  >
> {
  return new APIPromise($do(client, createTranslationRequestDto, idempotencyKey, options));
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.TranslationControllerCreateTranslationEndpointRequest$outboundSchema.parse(value),
