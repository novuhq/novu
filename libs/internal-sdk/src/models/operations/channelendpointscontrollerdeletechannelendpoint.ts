...
export function channelEndpointsControllerDeleteChannelEndpointResponseFromJSON(
  jsonString: string
): SafeParseResult<ChannelEndpointsControllerDeleteChannelEndpointResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ChannelEndpointsControllerDeleteChannelEndpointResponse$inboundSchema.parse(JSON.parse(x)),
