 ...
 * Direction of sorting
 */
export type ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection = ClosedEnum<
...
export type ChannelEndpointsControllerListChannelEndpointsRequest = {
   ...
   * Direction of sorting
   */
  orderDirection?: ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection | undefined;
  /**
   * Field to order by
   */
...
export const ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection$outboundSchema: z.ZodNativeEnum<
  typeof ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection
> = z.nativeEnum(ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection);
...
> = z
  .object({
    ...
    orderDirection: ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection$outboundSchema.optional(),
...
export function channelEndpointsControllerListChannelEndpointsResponseFromJSON(
  jsonString: string
): SafeParseResult<ChannelEndpointsControllerListChannelEndpointsResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ChannelEndpointsControllerListChannelEndpointsResponse$inboundSchema.parse(JSON.parse(x)),
