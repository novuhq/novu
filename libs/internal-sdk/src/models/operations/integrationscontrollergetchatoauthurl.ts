...
> = z
  .object({
    ...
    generateChatOauthUrlRequestDto: components.GenerateChatOauthUrlRequestDto$outboundSchema,
  })
  .transform((v) => {
    return remap$(v, {
...
export function integrationsControllerGetChatOAuthUrlRequestToJSON(
  ...
  return JSON.stringify(
    IntegrationsControllerGetChatOAuthUrlRequest$outboundSchema.parse(integrationsControllerGetChatOAuthUrlRequest)
  );
}
...
export function integrationsControllerGetChatOAuthUrlResponseFromJSON(
  jsonString: string
): SafeParseResult<IntegrationsControllerGetChatOAuthUrlResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => IntegrationsControllerGetChatOAuthUrlResponse$inboundSchema.parse(JSON.parse(x)),
