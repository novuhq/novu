...
export function channelConnectionsControllerGetChannelConnectionByIdentifierResponseFromJSON(
  jsonString: string
): SafeParseResult<ChannelConnectionsControllerGetChannelConnectionByIdentifierResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ChannelConnectionsControllerGetChannelConnectionByIdentifierResponse$inboundSchema.parse(JSON.parse(x)),
