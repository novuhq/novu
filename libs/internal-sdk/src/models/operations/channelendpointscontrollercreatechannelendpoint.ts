...
export function channelEndpointsControllerCreateChannelEndpointResponseFromJSON(
  jsonString: string
): SafeParseResult<ChannelEndpointsControllerCreateChannelEndpointResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ChannelEndpointsControllerCreateChannelEndpointResponse$inboundSchema.parse(JSON.parse(x)),
