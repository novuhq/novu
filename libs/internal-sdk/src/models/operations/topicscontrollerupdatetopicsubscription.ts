...
> = z
  .object({
    ...
    updateTopicSubscriptionRequestDto: components.UpdateTopicSubscriptionRequestDto$outboundSchema,
  })
  .transform((v) => {
    return remap$(v, {
...
export function topicsControllerUpdateTopicSubscriptionRequestToJSON(
  ...
  return JSON.stringify(
    TopicsControllerUpdateTopicSubscriptionRequest$outboundSchema.parse(topicsControllerUpdateTopicSubscriptionRequest)
  );
}
...
export function topicsControllerUpdateTopicSubscriptionResponseFromJSON(
  jsonString: string
): SafeParseResult<TopicsControllerUpdateTopicSubscriptionResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TopicsControllerUpdateTopicSubscriptionResponse$inboundSchema.parse(JSON.parse(x)),
