...
export function channelConnectionsControllerDeleteChannelConnectionResponseFromJSON(
  jsonString: string
): SafeParseResult<ChannelConnectionsControllerDeleteChannelConnectionResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ChannelConnectionsControllerDeleteChannelConnectionResponse$inboundSchema.parse(JSON.parse(x)),
