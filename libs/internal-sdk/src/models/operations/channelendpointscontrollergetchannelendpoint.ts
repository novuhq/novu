...
export function channelEndpointsControllerGetChannelEndpointResponseFromJSON(
  jsonString: string
): SafeParseResult<ChannelEndpointsControllerGetChannelEndpointResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ChannelEndpointsControllerGetChannelEndpointResponse$inboundSchema.parse(JSON.parse(x)),
