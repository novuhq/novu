...
> = z
  .object({
    ...
    updateChannelEndpointRequestDto: components.UpdateChannelEndpointRequestDto$outboundSchema,
  })
  .transform((v) => {
    return remap$(v, {
...
export function channelEndpointsControllerUpdateChannelEndpointResponseFromJSON(
  jsonString: string
): SafeParseResult<ChannelEndpointsControllerUpdateChannelEndpointResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ChannelEndpointsControllerUpdateChannelEndpointResponse$inboundSchema.parse(JSON.parse(x)),
