...
export type DeleteTopicSubscriptionsRequestDtoSubscriptions = string | DeleteTopicSubscriberIdentifierDto;
...
export type DeleteTopicSubscriptionsRequestDto$Outbound = {
  subscriberIds?: Array<string> | undefined;
  subscriptions?: Array<string | DeleteTopicSubscriberIdentifierDto$Outbound> | undefined;
};
...
> = z.object({
  ...
  subscriptions: z.array(z.union([z.string(), DeleteTopicSubscriberIdentifierDto$outboundSchema])).optional(),
});
