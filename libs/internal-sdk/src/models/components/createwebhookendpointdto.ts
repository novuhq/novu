...
export type CreateWebhookEndpointDtoContext = CreateWebhookEndpointDtoContext2 | string;
...
export type CreateWebhookEndpointDto = {
   ...
   */
  subscriberId: string;
  context?: { [k: string]: CreateWebhookEndpointDtoContext2 | string } | undefined;
  /**
...
export function createWebhookEndpointDtoContext2ToJSON(
  ...
  return JSON.stringify(CreateWebhookEndpointDtoContext2$outboundSchema.parse(createWebhookEndpointDtoContext2));
}

/** @internal */
export type CreateWebhookEndpointDtoContext$Outbound = CreateWebhookEndpointDtoContext2$Outbound | string;
...
> = z.union([z.lazy(() => CreateWebhookEndpointDtoContext2$outboundSchema), z.string()]);

export function createWebhookEndpointDtoContextToJSON(
  createWebhookEndpointDtoContext: CreateWebhookEndpointDtoContext
): string {
  return JSON.stringify(CreateWebhookEndpointDtoContext$outboundSchema.parse(createWebhookEndpointDtoContext));
}
...
export type CreateWebhookEndpointDto$Outbound = {
  identifier?: string | undefined;
  subscriberId: string;
  context?: { [k: string]: CreateWebhookEndpointDtoContext2$Outbound | string } | undefined;
  integrationIdentifier: string;
  connectionIdentifier?: string | undefined;
  type: 'webhook';
...
> = z.object({
  ...
  context: z.record(z.union([z.lazy(() => CreateWebhookEndpointDtoContext2$outboundSchema), z.string()])).optional(),
...
export function createWebhookEndpointDtoToJSON(createWebhookEndpointDto: CreateWebhookEndpointDto): string {
  return JSON.stringify(CreateWebhookEndpointDto$outboundSchema.parse(createWebhookEndpointDto));
}
