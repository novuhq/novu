...
export function updateChannelEndpointRequestDtoEndpointToJSON(
  ...
  return JSON.stringify(
    UpdateChannelEndpointRequestDtoEndpoint$outboundSchema.parse(updateChannelEndpointRequestDtoEndpoint)
  );
}
...
export function updateChannelEndpointRequestDtoToJSON(
  ...
  return JSON.stringify(UpdateChannelEndpointRequestDto$outboundSchema.parse(updateChannelEndpointRequestDto));
}
