...
import { StepsOverrides, StepsOverrides$Outbound, StepsOverrides$outboundSchema } from './stepsoverrides.js';
import {
  SubscriberPayloadDto,
  SubscriberPayloadDto$Outbound,
  SubscriberPayloadDto$outboundSchema,
} from './subscriberpayloaddto.js';
import { TenantPayloadDto, TenantPayloadDto$Outbound, TenantPayloadDto$outboundSchema } from './tenantpayloaddto.js';
import { TopicPayloadDto, TopicPayloadDto$Outbound, TopicPayloadDto$outboundSchema } from './topicpayloaddto.js';
...
export type TriggerEventRequestDtoContext = TriggerEventRequestDtoContext2 | string;
...
export function triggerEventRequestDtoContext2ToJSON(
  ...
  return JSON.stringify(TriggerEventRequestDtoContext2$outboundSchema.parse(triggerEventRequestDtoContext2));
}

/** @internal */
export type TriggerEventRequestDtoContext$Outbound = TriggerEventRequestDtoContext2$Outbound | string;
...
> = z.union([z.lazy(() => TriggerEventRequestDtoContext2$outboundSchema), z.string()]);
...
export type TriggerEventRequestDto$Outbound = {
  ...
  context?: { [k: string]: TriggerEventRequestDtoContext2$Outbound | string } | undefined;
};
...
> = z
  .object({
    ...
    context: z.record(z.union([z.lazy(() => TriggerEventRequestDtoContext2$outboundSchema), z.string()])).optional(),
  })
  .transform((v) => {
    return remap$(v, {
      workflowId: 'name',
