...
export type GenerateChatOauthUrlRequestDtoContext = GenerateChatOauthUrlRequestDtoContext2 | string;
...
export type GenerateChatOauthUrlRequestDto = {
  ...
  context?: { [k: string]: GenerateChatOauthUrlRequestDtoContext2 | string } | undefined;
  /**
...
export function generateChatOauthUrlRequestDtoContext2ToJSON(
  ...
  return JSON.stringify(
    GenerateChatOauthUrlRequestDtoContext2$outboundSchema.parse(generateChatOauthUrlRequestDtoContext2)
  );
}

/** @internal */
export type GenerateChatOauthUrlRequestDtoContext$Outbound = GenerateChatOauthUrlRequestDtoContext2$Outbound | string;
...
> = z.union([z.lazy(() => GenerateChatOauthUrlRequestDtoContext2$outboundSchema), z.string()]);
...
export function generateChatOauthUrlRequestDtoContextToJSON(
  ...
  return JSON.stringify(
    GenerateChatOauthUrlRequestDtoContext$outboundSchema.parse(generateChatOauthUrlRequestDtoContext)
  );
}
...
> = z.object({
  ...
  context: z
    .record(z.union([z.lazy(() => GenerateChatOauthUrlRequestDtoContext2$outboundSchema), z.string()]))
    .optional(),
...
export function generateChatOauthUrlRequestDtoToJSON(
  ...
  return JSON.stringify(GenerateChatOauthUrlRequestDto$outboundSchema.parse(generateChatOauthUrlRequestDto));
}
