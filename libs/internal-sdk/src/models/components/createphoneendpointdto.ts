...
import { PhoneEndpointDto, PhoneEndpointDto$Outbound, PhoneEndpointDto$outboundSchema } from './phoneendpointdto.js';
...
export type CreatePhoneEndpointDtoContext = CreatePhoneEndpointDtoContext2 | string;
...
export function createPhoneEndpointDtoContext2ToJSON(
  ...
  return JSON.stringify(CreatePhoneEndpointDtoContext2$outboundSchema.parse(createPhoneEndpointDtoContext2));
}

/** @internal */
export type CreatePhoneEndpointDtoContext$Outbound = CreatePhoneEndpointDtoContext2$Outbound | string;
...
> = z.union([z.lazy(() => CreatePhoneEndpointDtoContext2$outboundSchema), z.string()]);

export function createPhoneEndpointDtoContextToJSON(
  createPhoneEndpointDtoContext: CreatePhoneEndpointDtoContext
): string {
  return JSON.stringify(CreatePhoneEndpointDtoContext$outboundSchema.parse(createPhoneEndpointDtoContext));
}
...
export type CreatePhoneEndpointDto$Outbound = {
  identifier?: string | undefined;
  subscriberId: string;
  context?: { [k: string]: CreatePhoneEndpointDtoContext2$Outbound | string } | undefined;
  integrationIdentifier: string;
  connectionIdentifier?: string | undefined;
  type: 'phone';
...
> = z.object({
  ...
  context: z.record(z.union([z.lazy(() => CreatePhoneEndpointDtoContext2$outboundSchema), z.string()])).optional(),
...
export function createPhoneEndpointDtoToJSON(createPhoneEndpointDto: CreatePhoneEndpointDto): string {
  return JSON.stringify(CreatePhoneEndpointDto$outboundSchema.parse(createPhoneEndpointDto));
}
