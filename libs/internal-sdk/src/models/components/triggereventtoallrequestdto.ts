...
export type TriggerEventToAllRequestDto = {
  ...
  context?: { [k: string]: TriggerEventToAllRequestDtoContext2 | string } | undefined;
};
...
export function triggerEventToAllRequestDtoContext2ToJSON(
  ...
  return JSON.stringify(TriggerEventToAllRequestDtoContext2$outboundSchema.parse(triggerEventToAllRequestDtoContext2));
}
...
> = z.union([z.lazy(() => TriggerEventToAllRequestDtoContext2$outboundSchema), z.string()]);
...
export function triggerEventToAllRequestDtoContextToJSON(
  ...
  return JSON.stringify(TriggerEventToAllRequestDtoContext$outboundSchema.parse(triggerEventToAllRequestDtoContext));
}
...
> = z.object({
  ...
  context: z.record(z.union([z.lazy(() => TriggerEventToAllRequestDtoContext2$outboundSchema), z.string()])).optional(),
});
