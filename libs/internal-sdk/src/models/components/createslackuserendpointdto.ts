...
export type CreateSlackUserEndpointDtoContext = CreateSlackUserEndpointDtoContext2 | string;
...
export type CreateSlackUserEndpointDto = {
   ...
   */
  subscriberId: string;
  context?: { [k: string]: CreateSlackUserEndpointDtoContext2 | string } | undefined;
  /**
...
export function createSlackUserEndpointDtoContext2ToJSON(
  ...
  return JSON.stringify(CreateSlackUserEndpointDtoContext2$outboundSchema.parse(createSlackUserEndpointDtoContext2));
}

/** @internal */
export type CreateSlackUserEndpointDtoContext$Outbound = CreateSlackUserEndpointDtoContext2$Outbound | string;
...
> = z.union([z.lazy(() => CreateSlackUserEndpointDtoContext2$outboundSchema), z.string()]);
...
export function createSlackUserEndpointDtoContextToJSON(
  ...
  return JSON.stringify(CreateSlackUserEndpointDtoContext$outboundSchema.parse(createSlackUserEndpointDtoContext));
}
...
> = z.object({
  ...
  context: z.record(z.union([z.lazy(() => CreateSlackUserEndpointDtoContext2$outboundSchema), z.string()])).optional(),
...
export function createSlackUserEndpointDtoToJSON(createSlackUserEndpointDto: CreateSlackUserEndpointDto): string {
  return JSON.stringify(CreateSlackUserEndpointDto$outboundSchema.parse(createSlackUserEndpointDto));
}
