...
export function msTeamsChannelEndpointDtoToJSON(msTeamsChannelEndpointDto: MsTeamsChannelEndpointDto): string {
  return JSON.stringify(MsTeamsChannelEndpointDto$outboundSchema.parse(msTeamsChannelEndpointDto));
}
