...
export type CreateMsTeamsChannelEndpointDtoContext = CreateMsTeamsChannelEndpointDtoContext2 | string;
...
export type CreateMsTeamsChannelEndpointDto = {
   ...
   */
  subscriberId: string;
  context?: { [k: string]: CreateMsTeamsChannelEndpointDtoContext2 | string } | undefined;
  /**
...
export function createMsTeamsChannelEndpointDtoContext2ToJSON(
  ...
  return JSON.stringify(
    CreateMsTeamsChannelEndpointDtoContext2$outboundSchema.parse(createMsTeamsChannelEndpointDtoContext2)
  );
}

/** @internal */
export type CreateMsTeamsChannelEndpointDtoContext$Outbound = CreateMsTeamsChannelEndpointDtoContext2$Outbound | string;
...
> = z.union([z.lazy(() => CreateMsTeamsChannelEndpointDtoContext2$outboundSchema), z.string()]);
...
export function createMsTeamsChannelEndpointDtoContextToJSON(
  ...
  return JSON.stringify(
    CreateMsTeamsChannelEndpointDtoContext$outboundSchema.parse(createMsTeamsChannelEndpointDtoContext)
  );
}
...
> = z.object({
  ...
  context: z
    .record(z.union([z.lazy(() => CreateMsTeamsChannelEndpointDtoContext2$outboundSchema), z.string()]))
    .optional(),
...
export function createMsTeamsChannelEndpointDtoToJSON(
  ...
  return JSON.stringify(CreateMsTeamsChannelEndpointDto$outboundSchema.parse(createMsTeamsChannelEndpointDto));
}
