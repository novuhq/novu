...
export type CreateMsTeamsUserEndpointDtoContext = CreateMsTeamsUserEndpointDtoContext2 | string;
...
export type CreateMsTeamsUserEndpointDto = {
   ...
   */
  subscriberId: string;
  context?: { [k: string]: CreateMsTeamsUserEndpointDtoContext2 | string } | undefined;
  /**
...
export function createMsTeamsUserEndpointDtoContext2ToJSON(
  ...
  return JSON.stringify(
    CreateMsTeamsUserEndpointDtoContext2$outboundSchema.parse(createMsTeamsUserEndpointDtoContext2)
  );
}

/** @internal */
export type CreateMsTeamsUserEndpointDtoContext$Outbound = CreateMsTeamsUserEndpointDtoContext2$Outbound | string;
...
> = z.union([z.lazy(() => CreateMsTeamsUserEndpointDtoContext2$outboundSchema), z.string()]);
...
export function createMsTeamsUserEndpointDtoContextToJSON(
  ...
  return JSON.stringify(CreateMsTeamsUserEndpointDtoContext$outboundSchema.parse(createMsTeamsUserEndpointDtoContext));
}
...
> = z.object({
  ...
  context: z
    .record(z.union([z.lazy(() => CreateMsTeamsUserEndpointDtoContext2$outboundSchema), z.string()]))
    .optional(),
...
export function createMsTeamsUserEndpointDtoToJSON(createMsTeamsUserEndpointDto: CreateMsTeamsUserEndpointDto): string {
  return JSON.stringify(CreateMsTeamsUserEndpointDto$outboundSchema.parse(createMsTeamsUserEndpointDto));
}
