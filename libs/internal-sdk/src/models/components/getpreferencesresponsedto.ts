...
import { PreferenceLevelEnum, PreferenceLevelEnum$inboundSchema } from './preferencelevelenum.js';
...
/** @internal */
export const Condition$inboundSchema: z.ZodType<Condition, z.ZodTypeDef, unknown> = z.object({});

export function conditionFromJSON(jsonString: string): SafeParseResult<Condition, SDKValidationError> {
  return safeParse(
    jsonString,
