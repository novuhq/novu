...
export type CreateSlackChannelEndpointDtoContext = CreateSlackChannelEndpointDtoContext2 | string;
...
export type CreateSlackChannelEndpointDto = {
   ...
   */
  subscriberId: string;
  context?: { [k: string]: CreateSlackChannelEndpointDtoContext2 | string } | undefined;
  /**
...
export function createSlackChannelEndpointDtoContext2ToJSON(
  ...
  return JSON.stringify(
    CreateSlackChannelEndpointDtoContext2$outboundSchema.parse(createSlackChannelEndpointDtoContext2)
  );
}

/** @internal */
export type CreateSlackChannelEndpointDtoContext$Outbound = CreateSlackChannelEndpointDtoContext2$Outbound | string;
...
> = z.union([z.lazy(() => CreateSlackChannelEndpointDtoContext2$outboundSchema), z.string()]);
...
export function createSlackChannelEndpointDtoContextToJSON(
  ...
  return JSON.stringify(
    CreateSlackChannelEndpointDtoContext$outboundSchema.parse(createSlackChannelEndpointDtoContext)
  );
}
...
> = z.object({
  ...
  context: z
    .record(z.union([z.lazy(() => CreateSlackChannelEndpointDtoContext2$outboundSchema), z.string()]))
    .optional(),
