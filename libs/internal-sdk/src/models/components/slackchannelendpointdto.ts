...
/** @internal */
export const SlackChannelEndpointDto$inboundSchema: z.ZodType<SlackChannelEndpointDto, z.ZodTypeDef, unknown> =
  z.object({
    channelId: z.string(),
  });
/** @internal */
...
export function slackChannelEndpointDtoToJSON(slackChannelEndpointDto: SlackChannelEndpointDto): string {
  return JSON.stringify(SlackChannelEndpointDto$outboundSchema.parse(slackChannelEndpointDto));
}
