...
/** @internal */
export const WebhookEndpointDto$inboundSchema: z.ZodType<WebhookEndpointDto, z.ZodTypeDef, unknown> = z.object({
  url: z.string(),
...
export function webhookEndpointDtoToJSON(webhookEndpointDto: WebhookEndpointDto): string {
  return JSON.stringify(WebhookEndpointDto$outboundSchema.parse(webhookEndpointDto));
}
