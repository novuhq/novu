...
export class Groups extends ClientSDK {
  ...
  async delete(
    ...
    return unwrapAsync(translationsGroupsDelete(this, resourceType, resourceId, idempotencyKey, options));
  }
  ...
  async retrieve(
    ...
    return unwrapAsync(translationsGroupsRetrieve(this, resourceType, resourceId, idempotencyKey, options));
  }
}
