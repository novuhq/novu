...
export class ChannelEndpoints extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(channelEndpointsCreate(this, requestBody, idempotencyKey, options));
  }
  ...
  async retrieve(
    ...
    return unwrapAsync(channelEndpointsRetrieve(this, identifier, idempotencyKey, options));
  }
  ...
  async update(
    ...
    return unwrapAsync(
      channelEndpointsUpdate(this, updateChannelEndpointRequestDto, identifier, idempotencyKey, options)
    );
  }
  ...
  async delete(
    ...
    idempotencyKey?: string | undefined,
    options?: RequestOptions
  ): Promise<operations.ChannelEndpointsControllerDeleteChannelEndpointResponse | undefined> {
    return unwrapAsync(channelEndpointsDelete(this, identifier, idempotencyKey, options));
  }
}
