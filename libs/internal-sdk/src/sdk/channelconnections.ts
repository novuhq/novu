...
export class ChannelConnections extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(channelConnectionsCreate(this, createChannelConnectionRequestDto, idempotencyKey, options));
  }
  ...
  async retrieve(
    ...
    return unwrapAsync(channelConnectionsRetrieve(this, identifier, idempotencyKey, options));
  }
  ...
  async update(
    ...
    return unwrapAsync(
      channelConnectionsUpdate(this, updateChannelConnectionRequestDto, identifier, idempotencyKey, options)
    );
  }
  ...
  async delete(
    ...
    idempotencyKey?: string | undefined,
    options?: RequestOptions
  ): Promise<operations.ChannelConnectionsControllerDeleteChannelConnectionResponse | undefined> {
    return unwrapAsync(channelConnectionsDelete(this, identifier, idempotencyKey, options));
  }
}
