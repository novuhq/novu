...
export function useActivityTrackMutation(
  options?: MutationHookOptions<ActivityTrackMutationData, Error, ActivityTrackMutationVariables>
): UseMutationResult<ActivityTrackMutationData, Error, ActivityTrackMutationVariables> {
