...
export function useTranslationsUploadMutation(
  options?: MutationHookOptions<TranslationsUploadMutationData, Error, TranslationsUploadMutationVariables>
): UseMutationResult<TranslationsUploadMutationData, Error, TranslationsUploadMutationVariables> {
