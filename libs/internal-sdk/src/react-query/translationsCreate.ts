...
export function useTranslationsCreateMutation(
  options?: MutationHookOptions<TranslationsCreateMutationData, Error, TranslationsCreateMutationVariables>
): UseMutationResult<TranslationsCreateMutationData, Error, TranslationsCreateMutationVariables> {
