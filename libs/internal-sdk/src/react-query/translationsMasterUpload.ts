...
export function useTranslationsMasterUploadMutation(
  options?: MutationHookOptions<TranslationsMasterUploadMutationData, Error, TranslationsMasterUploadMutationVariables>
): UseMutationResult<TranslationsMasterUploadMutationData, Error, TranslationsMasterUploadMutationVariables> {
...
export function buildTranslationsMasterUploadMutation(
  ...
  return {
    ...
    mutationFn: function translationsMasterUploadMutationFn({
      ...
      return unwrapAsync(translationsMasterUpload(client$, idempotencyKey, mergedOptions));
    },
  };
}
