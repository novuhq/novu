import {
  overrideWorkflowPreferences,
  filterWorkflowPreference,
} from './get-subscriber-workflow-preference.usecase';
...
describe('overridePreferences', function () {
  ...
  it('should be overridden by the subscribers preference', async function () {
    const workflowChannelPreference = {
      email: false,
      sms: true,
      in_app: true,
      chat: true,
  ...
  it('should get preference from workflow when subscriber preference are empty', async function () {
    const workflowChannelPreference = {
      email: false,
      sms: true,
      in_app: false,
...
describe('filteredPreference', function () {
  it('should filter active channels in the preference ', async function () {
    ...
    const channelPreferences = filterWorkflowPreference(
      preferences,
      activeChannels
    );
    const expectedPreferenceResult = {
