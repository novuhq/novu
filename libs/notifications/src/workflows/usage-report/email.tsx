...
//   return render(<UsageReportEmail {...payload} {...controls} />);
// }

export async function renderUsageReportEmail(payload: any, controls: any) {
  return render(<div {...payload} {...controls} />);
}
