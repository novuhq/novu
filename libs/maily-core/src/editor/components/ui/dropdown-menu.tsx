...
const DropdownMenuContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Content> & {
    /**
     * When false, render inline (no portal). Required inside Tippy bubble menus —
     * a portaled menu is treated as an outside click and unmounts the tippy, which
     * then positions the menu at the viewport origin.
     */
    portalled?: boolean;
  }
