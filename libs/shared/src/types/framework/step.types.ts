...
import { ActionTypeEnum, ChannelTypeEnum } from '../channel';
import { JobStatusEnum } from '../../entities/job';
...
export type EmailOutput = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.EMAIL]['output']>;
export type EmailResult = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.EMAIL]['result']>;

export type SmsOutput = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.SMS]['output']>;
export type SmsResult = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.SMS]['result']>;

export type PushOutput = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.PUSH]['output']>;
export type PushResult = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.PUSH]['result']>;

export type ChatOutput = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.CHAT]['output']>;
export type ChatResult = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.CHAT]['result']>;

export type InAppOutput = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.IN_APP]['output']>;
export type InAppResult = FromSchema<(typeof channelStepSchemas)[ChannelTypeEnum.IN_APP]['result']>;

export type DelayOutput = FromSchema<(typeof actionStepSchemas)[ActionTypeEnum.DELAY]['output']>;
export type DelayResult = FromSchema<(typeof actionStepSchemas)[ActionTypeEnum.DELAY]['result']>;
...
export type DigestOutput = FromSchema<(typeof actionStepSchemas)[ActionTypeEnum.DIGEST]['output']>;
export type DigestResult = FromSchema<(typeof actionStepSchemas)[ActionTypeEnum.DIGEST]['result']>;
...
export type Step = {
  /** Send an email. */
  email: ChannelStep<ChannelTypeEnum.EMAIL, EmailOutput, EmailResult>;
  /** Send an SMS. */
  sms: ChannelStep<ChannelTypeEnum.SMS, SmsOutput, SmsResult>;
  /** Send a push notification. */
  push: ChannelStep<ChannelTypeEnum.PUSH, PushOutput, PushResult>;
  /** Send a chat message. */
  chat: ChannelStep<ChannelTypeEnum.CHAT, ChatOutput, ChatResult>;
  /** Send an in-app notification. */
  inApp: ChannelStep<ChannelTypeEnum.IN_APP, InAppOutput, InAppResult>;
