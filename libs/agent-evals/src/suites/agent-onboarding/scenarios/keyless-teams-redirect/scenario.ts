...
export const scenario: EvalScenario<ConnectFlags> = {
  id: 'keyless-teams-redirect',
  category: 'keyless',
  description: 'Keyless MS Teams must redirect to dashboard without running connect.',
  userPrompt: 'Connect a Novu agent to Microsoft Teams for this project.',
  projectRoot: path.join(scenarioDir, 'project'),
  scriptedAnswers: [
    { questionContains: 'channel', optionId: 'dashboard' },
    { questionContains: 'teams', optionId: 'teams' },
  ],
};
