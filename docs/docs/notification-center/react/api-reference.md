...
| subscriberHash          | string (optional)                                                | The HMAC encrypted `subscrinerId`, [more info](./react-components.md#enabling-hmac-encryption).                                                                                                                                                                                                                                                                                                                     |
...
| theme                | [object](./api-reference#the-theme-interface) (optional)       | Deprecated, please use the [styles](./api-reference#styles-interface) prop on the NovuProvider. The theme object allowing you to override light and dark colors of the UI components.                                         |
| tabs                 | [object[]](./api-reference#the-tab-interface) (optional)       | Allows to defined separate UI tabs for the notifications feed. The array of connection objects between the feed tab and [store](./api-reference#store-interface) (that you define on the `NovuProvider`) and feed identifier. |
...
| showUserPreferences  | boolean (optional)                                             | The flag that enables to show/hide the user preferences. By default it is shown.                                                                                                                                              |
| onUrlChange          | function (optional)                                            | The function that is called when when the notification item has a CTA of type redirect and is clicked.                                                                                                                        |
| onNotificationClick  | function (optional)                                            | The function that is called when when the notification item is clicked.                                                                                                                                                       |
| onUnseenCountChanged | function (optional)                                            | The function that is called when when the unseen notifications count changed.                                                                                                                                                 |
| children             | function                                                       | The render function that allows you to defined the custom bell button. It's called with an argument that has `unseenCount` prop the number of unseen notifications.                                                           |
| header               | function (optional)                                            | The render function that allows you to defined the custom header component.                                                                                                                                                   |
| footer               | function (optional)                                            | The render function that allows you to defined the custom footer component.                                                                                                                                                   |
| emptyState           | function (optional)                                            | The render function that allows you to defined the custom component for the empty notifications list state.                                                                                                                   |
| onActionClick        | function (optional)                                            | The callback function triggered when the notification button is clicked.                                                                                                                                                      |
| actionsResultBlock   | function (optional)                                            | The render function that allows you to defined the custom component that will be rendered after the notification button is clicked.                                                                                           |
...
The hook that has only responsible for fetching the notifications for a particular feed. It's a thin version of the `useNotifications` hook and is based on the `useInfiniteQuery` hook from the `react-query` library.
