...
The overrides field supports an email property that should have the interface of this:
...
You can easily send attachments with the Novu API by passing the attachments array when triggering an Email based workflow.
