...
<div align="center">
  <picture>
    <source
      ...
      srcset="/img/platform/layouts/dark-manage-layouts.png"
    />
...
- Manage layout variables - set default values or required variables.
  ...
  <div align="center">
    <picture>
      <source
        media="(prefers-color-scheme: dark)"
        srcset="/img/platform/layouts/dark-create-layout.png"
      />
...
<div align="center">
  <picture>
    <source
      media="(prefers-color-scheme: dark)"
      srcset="/img/platform/layouts/dark-assign-layout.png"
    />
