...
description: "Update workflow definitions in the Novu Development environment through the API, then publish them to Staging and Production through CI/CD pipelines."
---
