...
description: "Send signup, password reset, and authentication alert notifications from Supabase Auth events using Novu workflows, subscribers, and multi-channel delivery."
---
