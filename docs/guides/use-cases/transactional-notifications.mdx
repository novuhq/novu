...
Send transactional notifications through Novu by <GlossaryTerm term="trigger">triggering</GlossaryTerm> a <GlossaryTerm term="workflow">workflow</GlossaryTerm> when a business event occurs in your application. Novu delivers the message across in-app, email, SMS, push, or chat based on your workflow steps and the <GlossaryTerm term="subscriber">subscriber's</GlossaryTerm> contact details.
