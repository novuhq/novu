...
sidebarTitle: 'Digest'
description: 'Batch and summarize notifications with Novu digest steps. Send digests like "10 new comments" instead of individual alerts, with configurable windows and keys.'
---
