...
Let <GlossaryTerm term="subscriber">subscribers</GlossaryTerm> control how they receive notifications using Novu's built-in <GlossaryTerm term="preference">preference</GlossaryTerm> management. The <GlossaryTerm term="inbox">Inbox</GlossaryTerm> component includes a preferences UI, and the REST API lets you read and update preferences programmatically.
