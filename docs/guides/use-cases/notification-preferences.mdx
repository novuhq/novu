...
description: "Let subscribers manage notification preferences per workflow and channel using the Novu Inbox component and the preferences API for user-facing settings."
---


Let <Tooltip headline="Subscriber" tip="An entity designated to receive notifications, uniquely identified by subscriberId within an environment." cta="Learn more" href="/platform/concepts/subscribers">subscribers</Tooltip> control how they receive notifications using Novu's built-in <Tooltip headline="Preference" tip="Rules that control whether notifications are sent on a channel, at workflow, subscriber, or subscription scope." cta="Learn more" href="/platform/concepts/preferences">preference</Tooltip> management. The <Tooltip headline="Inbox" tip="Novu's in-app notification UI and client SDK component that delivers in_app messages, unread counts, and preferences." cta="Set up Inbox" href="/platform/inbox">Inbox</Tooltip> component includes a preferences UI, and the REST API lets you read and update preferences programmatically.
