...
description: "Build password reset, email verification, and authentication alert workflows with Novu using email and in-app channels, subscribers, and secure token payloads."
---
