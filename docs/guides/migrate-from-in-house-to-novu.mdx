...
description: "Replace a custom-built notification system with Novu. Reduce maintenance, add multi-channel delivery, and ship an in-app Inbox faster than building it yourself."
---
