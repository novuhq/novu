...
description: "Migrate your notification infrastructure from Courier to Novu step by step. Map templates and profiles to Novu workflows and subscribers with minimal downtime."
---
