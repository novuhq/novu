---
title: 'Inngest'
description: "Integrate Inngest with Novu to trigger notification workflows from background jobs and durable functions. Covers setup, event sending, and best practices."
---
