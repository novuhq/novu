---
title: 'Stripe'
description: "Integrate Stripe webhooks with Novu notifications in a Next.js application. Trigger workflows on payments, subscriptions, invoices, and refund events."
---
