---
title: 'Webhooks'
description: "Configure webhook endpoints in Novu to receive real-time event notifications for workflow updates, message delivery, and subscriber activity."
---
