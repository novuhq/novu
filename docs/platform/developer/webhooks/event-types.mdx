---
title: 'Event types'
description: "Reference of every event type Novu emits through webhooks, including message, subscriber, workflow, and delivery events with example payload structures."
---
