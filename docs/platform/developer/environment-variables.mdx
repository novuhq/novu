...
description: "Create reusable, environment-scoped variables in the Novu dashboard and reference them inside workflow steps to avoid hardcoding secrets and URLs."
---
