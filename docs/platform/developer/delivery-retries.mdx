...
Webhooks that Novu sends to your endpoints follow a separate, much longer schedule: 8 attempts over roughly 24 hours, starting immediately and backing off to a 10 hour ceiling.
