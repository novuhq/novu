...
Novu uses <GlossaryTerm term="environment">environments</GlossaryTerm> to separate your workflows and its data. This lets you safely test changes, like a new workflow, in one environment before moving it to a live production environment.
...
Novu provides a <GlossaryTerm term="publish">publish</GlossaryTerm> mechanism that allows you to promote changes from your development environment to production or other custom environments. This process ensures that all changes are deliberate, reviewed, and deployed in a controlled manner.
