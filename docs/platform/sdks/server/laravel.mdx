---
title: 'Laravel'
description: "Connect a Laravel application to Novu with the official PHP server SDK to trigger workflows, manage subscribers, and send notifications from PHP."
---
