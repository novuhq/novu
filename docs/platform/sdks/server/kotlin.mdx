---
title: 'Kotlin'
description: "Connect a Kotlin application to Novu with the official server SDK to trigger workflows, manage subscribers, and send notifications from JVM code."
---
