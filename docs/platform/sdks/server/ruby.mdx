---
title: 'Ruby'
description: "Connect a Ruby application to Novu with the official server SDK to trigger workflows, manage subscribers, and send notifications from Ruby code."
---
