---
title: 'PHP SDK'
description: "Connect a PHP application to Novu with the official server SDK to trigger workflows, manage subscribers, and send notifications from PHP code."
---
