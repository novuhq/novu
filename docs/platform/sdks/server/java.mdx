---
title: 'Java'
description: "Connect a Java application to Novu with the official server SDK to trigger workflows, manage subscribers, and send notifications from JVM code."
---
