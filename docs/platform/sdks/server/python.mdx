---
title: 'Python'
description: "Connect a Python application to Novu with the official server SDK to trigger workflows, manage subscribers, and send notifications from Python."
---
