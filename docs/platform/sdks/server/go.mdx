---
title: 'Go SDK'
description: "Connect a Go application to Novu with the official server SDK to trigger workflows, manage subscribers, and send notifications from Go services."
---
