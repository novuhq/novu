---
title: 'useNovu'
description: "Use the useNovu hook to access the Novu client instance inside your React Native components for actions like marking notifications as read."
---
