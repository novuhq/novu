...
description: "Use the usePreferences hook to fetch and update per-channel and per-workflow notification preferences for subscribers in your React Native app."
---
