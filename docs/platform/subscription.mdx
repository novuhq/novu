...
<Note>
  ...
  Subscribers filtered out by subscription Context or JSON Logic conditions do not create a workflow run and are not counted toward usage. See [Billing and workflow runs](/platform/subscription/manage-topic-subscriptions#billing-and-workflow-runs).
</Note>
