...
description: "Fully customize the Novu Inbox bell icon using your own React components or third-party icon libraries to match your product branding and design system."
---
