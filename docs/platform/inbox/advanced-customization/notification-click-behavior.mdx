...
description: "Configure routing and click handling for notifications in the Novu Inbox using routerPush, onNotificationClick, and per-action redirect URLs."
---
