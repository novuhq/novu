---
title: 'Localization'
description: "Customize the Novu Inbox UI for different languages using the localization prop to translate labels, empty states, and accessibility strings."
---
