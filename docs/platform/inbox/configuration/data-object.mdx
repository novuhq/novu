---
title: 'Data Object'
description: "Attach custom metadata to in-app notifications with the data object in Novu workflows and read it inside the Inbox component for custom rendering."
---
