---
title: 'Data object for Inbox notifications'
description: 'Attach custom key-value metadata to in-app notifications with the Inbox data object to personalize rendering and filter tabs by data attributes.'
---
