---
title: 'Preferences'
description: "Configure and customize subscriber notification preferences directly inside your application using the built-in Preferences view of the Novu Inbox."
---

The <Tooltip headline="Preference" tip="Rules that control whether notifications are sent on a channel, at workflow, subscriber, or subscription scope." cta="Learn more" href="/platform/concepts/preferences">Preferences</Tooltip> interface in the <Tooltip headline="Inbox" tip="Novu's in-app notification UI and client SDK component that delivers in_app messages, unread counts, and preferences." cta="Set up Inbox" href="/platform/inbox">Inbox</Tooltip> component lets <Tooltip headline="Subscriber" tip="An entity designated to receive notifications, uniquely identified by subscriberId within an environment." cta="Learn more" href="/platform/concepts/subscribers">subscribers</Tooltip> customize how they receive notifications. By default, Novu renders a preferences icon inside the Inbox component, giving users access to global and workflow-specific settings directly from the UI.
