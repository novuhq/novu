...
The <GlossaryTerm term="preference">Preferences</GlossaryTerm> interface in the <GlossaryTerm term="inbox">Inbox</GlossaryTerm> component lets <GlossaryTerm term="subscriber">subscribers</GlossaryTerm> customize how they receive notifications. By default, Novu renders a preferences icon inside the Inbox component, giving users access to global and workflow-specific settings directly from the UI.
