...
description: "Prepare your Novu Inbox for production by enabling HMAC encryption to secure subscriber sessions, removing branding, and configuring the component for scale."
---
