...
<Note>
  This toggle applies to the **Inbox UI component only**. It does not change the content of emails, SMS, push, or chat messages. To remove Novu branding from email notifications, edit your email layouts and templates directly to remove any Novu-branded footer or content.
</Note>
...
If you do not see the toggle, confirm that your workspace is on a paid plan. The option is hidden on the free plan.