...
The <Tooltip headline="Inbox" tip="Novu's in-app notification UI and client SDK component that delivers in_app messages, unread counts, and preferences." cta="Set up Inbox" href="/platform/inbox">Inbox</Tooltip> component displays a notification bell by default, which opens a menu containing the <Tooltip headline="Subscriber" tip="An entity designated to receive notifications, uniquely identified by subscriberId within an environment." cta="Learn more" href="/platform/concepts/subscribers">subscriber's</Tooltip> notifications and <Tooltip headline="Preference" tip="Rules that control whether notifications are sent on a channel, at workflow, subscriber, or subscription scope." cta="Learn more" href="/platform/concepts/preferences">preferences</Tooltip>.
