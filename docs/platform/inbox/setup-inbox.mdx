...
The <GlossaryTerm term="inbox">Inbox</GlossaryTerm> component displays a notification bell by default, which opens a menu containing the <GlossaryTerm term="subscriber">subscriber's</GlossaryTerm> notifications and <GlossaryTerm term="preference">preferences</GlossaryTerm>.
