---
title: 'Headless Mode'
description: "Build a fully custom in-app notification UI with Novu using headless hooks that give you data, actions, and state without any prebuilt components."
---
