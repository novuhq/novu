...
<Steps>
  ...
  Update the `src/app/app.ts` file to add the Inbox component. You'll need to provide your <GlossaryTerm term="application-identifier">applicationIdentifier</GlossaryTerm> and <GlossaryTerm term="subscriber-id">subscriberId</GlossaryTerm>:
