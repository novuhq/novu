...
<html lang="en">
  ...
  In above code, replace `NOVU_APPLICATION_IDENTIFIER` with actual <GlossaryTerm term="application-identifier">applicationIdentifier</GlossaryTerm> value and `NOVU_SUBSCRIBER_ID` with actual <GlossaryTerm term="subscriber-id">subscriberId</GlossaryTerm> value.
