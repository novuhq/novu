...
description: "Integrate Novu in-app notifications into your Remix application. Step-by-step setup from install through to sending your first notification to a subscriber."
sidebarTitle: 'Remix'
---
