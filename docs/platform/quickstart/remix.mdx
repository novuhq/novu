...
<Steps>
  ...
  In the `app` directory, create a `components/notification-center.tsx` file and use the [`<Inbox />`](/platform/inbox) component, passing <GlossaryTerm term="application-identifier">applicationIdentifier</GlossaryTerm> and <GlossaryTerm term="subscriber-id">subscriberId</GlossaryTerm>:
