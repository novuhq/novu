...
```
    ...
    If you are signed in to your Novu account, then the <GlossaryTerm term="application-identifier">applicationIdentifier</GlossaryTerm> and <GlossaryTerm term="subscriber-id">subscriberId</GlossaryTerm> will be automatically populated. Otherwise, retrieve them from:
