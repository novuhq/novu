...
<Steps>
  ...
  Create the `src/components/NovuInbox.vue` file to add the Inbox component passing <GlossaryTerm term="application-identifier">applicationIdentifier</GlossaryTerm> and <GlossaryTerm term="subscriber-id">subscriberId</GlossaryTerm>:
