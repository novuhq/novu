...
<Steps>
  ...
  In the `src` directory, create a `components/novu-inbox.tsx` file and use the [`<Inbox />`](/platform/inbox) component, passing <GlossaryTerm term="application-identifier">applicationIdentifier</GlossaryTerm> and <GlossaryTerm term="subscriber-id">subscriberId</GlossaryTerm>:
