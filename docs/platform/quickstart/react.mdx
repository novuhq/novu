...
description: "Integrate the Novu Inbox component into your React application, add routing with React Router, and start showing real-time in-app notifications to your users."
sidebarTitle: 'React'
---
