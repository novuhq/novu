...
description: "Browse Novu's official and community SDKs for Node, Python, Go, PHP, .NET, Java, React, Svelte, React Native, and the Headless client for custom UIs."
---
...
<Columns cols={2}>
  <Card title="Typescript" icon="/images/icons/typescript.svg" href="/framework/typescript/overview">
...
<Columns cols={2}>
  <Card title="React" icon="/images/icons/react.svg" href="/platform/inbox/setup-inbox">
  ...
  <Card title="Headless" icon="/images/icons/javascript.svg" href="/platform/inbox/headless-mode">
