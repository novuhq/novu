...
Add real-time in-app notifications to your application with the Novu <GlossaryTerm term="inbox">Inbox</GlossaryTerm> component. Install a client SDK such as [`@novu/react`](/platform/sdks/react), render the [`<Inbox />`](/platform/inbox/setup-inbox) component with your <GlossaryTerm term="application-identifier">application identifier</GlossaryTerm> and <GlossaryTerm term="subscriber-id">subscriber ID</GlossaryTerm>, and Novu handles delivery, unread counts, and <GlossaryTerm term="preference">preferences</GlossaryTerm>.
