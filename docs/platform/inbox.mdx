---
title: 'Novu Inbox - In-App Notification Component for React and Svelte'
description: "Integrate the Novu Inbox component for real-time in-app notifications in React, Svelte, or JavaScript applications. Drop-in UI with bell icon, feed, and preferences."
sidebarTitle: 'Introduction to Inbox'
---


Add real-time in-app notifications to your application with the Novu Inbox component. Install a client SDK such as [`@novu/react`](/platform/sdks/react) or [`@novu/svelte`](/platform/quickstart/svelte), render the [`<Inbox />`](/platform/inbox/setup-inbox) component with your application identifier and subscriber ID, and Novu handles delivery, unread counts, and preferences.
...
<Note>
  Inbox is one-way notifications. For two-way in-app chat with an agent, see [Web Chat](/agents/channels/web-chat).
</Note>
...
![Fully functional and customizable Inbox component with bell, notification feed, and preference controls](/images/inbox/overview@2x.png)
...
For maximum flexibility and complete control over the look and feel, use the [@novu/react SDK](/platform/sdks/react) for React hooks or the [@novu/js SDK](/platform/sdks/javascript) for framework-agnostic JavaScript methods.
...
<AccordionGroup>
  <Accordion title="How do I add the Inbox to my app?">
    Follow a framework quickstart such as [Next.js](/platform/quickstart/nextjs), [React](/platform/quickstart/react), or [Svelte](/platform/quickstart/svelte). Install the SDK, add the `<Inbox />` component with your application identifier and subscriber ID, then trigger a workflow from the Novu Dashboard.
  </Accordion>
  <Accordion title="Can I customize the Inbox UI?">
    Yes. Use the appearance and component props from [`@novu/react`](/platform/sdks/react) or [`@novu/svelte`](/platform/quickstart/svelte), or use [`@novu/js`](/platform/sdks/javascript) to build a fully custom Inbox experience.
  </Accordion>
