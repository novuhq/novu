...
description: "Filter visible preferences, customize the Subscription component styling, and use custom render functions to tailor the Novu subscription UI."
---
