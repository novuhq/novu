...
description: "Build a fully custom subscription and preference management interface with Novu using headless hooks that expose data, mutations, and state."
---
...
<Note>
  Hooks are available in [`@novu/nextjs`](/platform/sdks/react), [`@novu/react-native`](/platform/sdks/react-native), [`@novu/react`](/platform/sdks/react). For a complete guide including server API and JSON Logic conditions, see [Manage topic subscriptions](/platform/subscription/manage-topic-subscriptions). For hook reference, see the [API reference documentation](/platform/sdks/react/hooks/subscription).
</Note>
