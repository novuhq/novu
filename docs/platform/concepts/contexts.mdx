...
<CardGroup cols={2}>
  ...
  <Card title="Provider routing" icon="plug-zap" href="/platform/integrations/integration-conditions">
    Select a tenant-specific email, SMS, chat, or push integration with conditions on `context.tenant.id`.
  </Card>
