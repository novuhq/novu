...
To choose among multiple active integrations from subscriber or [context](/platform/concepts/contexts) data, see [Integration conditions](/platform/integrations/integration-conditions).
