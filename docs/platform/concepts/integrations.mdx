---
title: 'Integrations'
description: "Learn how Novu integrations connect your account to third-party email, SMS, push, and chat providers with credentials, environments, and identifiers."
---

In Novu, <Tooltip headline="Integration" tip="An environment-scoped, configured connection to a third-party provider with credentials and channel settings." cta="Learn more" href="/platform/concepts/integrations">integrations</Tooltip> are configured connections to third-party services that deliver notifications across supported channels, which are email, SMS, push, and chat.
...
- A <Tooltip headline="Provider" tip="A third-party service that delivers notifications on a channel, such as SendGrid for email or Twilio for SMS." cta="Learn more" href="/platform/concepts/integrations">provider</Tooltip> is the third-party service responsible for sending messages (for example, Twilio, SendGrid, Slack).
- An integration is your instance of that provider, configured with the necessary <Tooltip headline="Credential" tip="Encrypted authentication and configuration values stored on an integration, such as API keys and OAuth tokens." cta="Learn more" href="/platform/concepts/integrations">credentials</Tooltip> and settings.
