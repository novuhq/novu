...
Novu copies tags onto each notification at create time. Historical Inbox items keep the tags they were created with. See [Tags](/platform/workflow/configure-workflow#tags).
