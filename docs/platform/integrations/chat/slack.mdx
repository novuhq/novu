...
```
  ...
  If your app uses short-lived tokens, see [Token rotation](#token-rotation) for the additional credentials to register.
</Note>
...
Every [`chat.postMessage`](https://api.slack.com/methods/chat.postMessage) argument is available:
