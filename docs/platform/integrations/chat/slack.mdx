...
5. Pick a Slack workspace to develop your app in.
...
5. Paste the Novu OAuth callback URL. Add the redirect URL that matches your Novu region:
    - US region:
      ```
    ...
    - EU region:
      ...
      ```
6. Click **Add** to save the URLs. If you use a self-hosted Novu instance, then add your instance's callback URL instead.
