...
description: "Connect Adding Chat Channel to Novu to send chat notifications through notification workflows. Step-by-step credential setup."
---

To send chat notifications through Novu using Adding Chat Channel, add your Adding Chat Channel credentials as a chat integration in the Novu Dashboard.
