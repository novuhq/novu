...
description: "Connect Mattermost to Novu to send chat notifications through workflows. Configure incoming webhooks in Mattermost and store credentials in the Novu dashboard."
---
