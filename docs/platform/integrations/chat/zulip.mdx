...
sidebarTitle: 'Zulip'
description: "Connect Zulip to Novu to send chat notifications through workflows. Create a bot in Zulip, generate the webhook URL, and store credentials for stream delivery."
---
