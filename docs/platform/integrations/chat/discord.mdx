...
description: "Connect Discord to Novu to send chat notifications through workflows. Create a bot, generate the webhook URL, and store credentials for delivery to channels."
---
