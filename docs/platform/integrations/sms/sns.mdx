---
title: "SNS SMS Integration with Novu"
sidebarTitle: 'SNS'
description: "Connect SNS to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using SNS, add your SNS credentials as an SMS integration in the Novu Dashboard.
