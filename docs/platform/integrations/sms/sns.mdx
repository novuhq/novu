...
sidebarTitle: 'SNS'
description: "Connect Amazon SNS SMS to Novu to send SMS notifications through workflows. Configure IAM credentials and the SNS region in the Novu dashboard for global SMS."
---
