---
title: "BulkSMS SMS Integration with Novu"
sidebarTitle: 'BulkSMS'
description: "Connect BulkSMS to Novu to send SMS notifications through workflows. Store your BulkSMS token ID and secret in the dashboard for cross-country delivery."
---

You can use the [BulkSMS](https://bulksms.com/) provider to send SMS messages to the customers using the Novu Platform with a single API to create multi-channel experiences.
