...
description: "Connect BulkSMS to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using BulkSMS, add your BulkSMS credentials as an SMS integration in the Novu Dashboard.
