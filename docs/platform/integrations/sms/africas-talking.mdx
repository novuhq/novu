...
description: "Connect Africa's Talking to Novu to send SMS notifications through workflows across Africa. Store your API key, username, and sender ID in the Novu dashboard."
---
