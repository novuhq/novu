...
sidebarTitle: 'Plivo'
description: "Connect Plivo to Novu to send SMS notifications through workflows. Store your Plivo Auth ID, Auth token, and sender in the Novu dashboard for reliable delivery."
---
