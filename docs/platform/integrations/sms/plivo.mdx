---
title: "Plivo SMS Integration with Novu"
sidebarTitle: 'Plivo'
description: "Connect Plivo to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using Plivo, add your Plivo credentials as an SMS integration in the Novu Dashboard.
