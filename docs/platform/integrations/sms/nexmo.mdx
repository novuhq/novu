...
sidebarTitle: 'Nexmo'
description: "Connect Vonage (Nexmo) to Novu to send SMS notifications through workflows. Store your Vonage API key and secret in the Novu dashboard for global SMS delivery."
---
