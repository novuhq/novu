...
description: "Connect Sendchamp to Novu to send SMS notifications through workflows. Store your Sendchamp public key and sender name in the dashboard for delivery in Africa."
---
