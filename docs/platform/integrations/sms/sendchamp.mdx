---
title: "Sendchamp SMS Integration with Novu"
sidebarTitle: 'Sendchamp'
description: "Connect Sendchamp to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using Sendchamp, add your Sendchamp credentials as an SMS integration in the Novu Dashboard.
