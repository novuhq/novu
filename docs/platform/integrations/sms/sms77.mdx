---
title: "SMS77 SMS Integration with Novu"
sidebarTitle: 'SMS77'
description: "Connect SMS77 to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using SMS77, add your SMS77 credentials as an SMS integration in the Novu Dashboard.
