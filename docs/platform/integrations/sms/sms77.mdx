...
sidebarTitle: 'SMS77'
description: "Connect seven.io (SMS77) to Novu to send SMS notifications through workflows. Store your seven.io API key and sender ID in the dashboard for global delivery."
---
