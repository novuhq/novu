...
description: "Connect ClickSend to Novu to send SMS notifications through workflows. Store your ClickSend username and API key in the dashboard for verified SMS delivery."
---
