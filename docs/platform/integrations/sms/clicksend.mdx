---
title: "Clicksend SMS Integration with Novu"
sidebarTitle: 'Clicksend'
description: "Connect Clicksend to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using Clicksend, add your Clicksend credentials as an SMS integration in the Novu Dashboard.
