...
sidebarTitle: 'Twilio'
description: "Connect Twilio to Novu to send SMS notifications through workflows. Store your Twilio account SID, auth token, and sender phone number in the Novu dashboard."
---
