---
title: "Infobip SMS Integration with Novu"
sidebarTitle: "Infobip - SMS"
description: "Connect Infobip SMS to Novu to send SMS notifications through workflows. Store your Infobip API key and base URL in the Novu dashboard for global SMS delivery."
---
...
<Note>
  Novu's Infobip integration only supports the **SMS** and **Email** channels. Infobip's WhatsApp, Viber, and Voice channels are not exposed through this integration. To send WhatsApp messages through Novu, use the [WhatsApp Business](/platform/integrations/chat/whats-app) or [Twilio](/platform/integrations/sms/twilio) integrations instead.
</Note>
