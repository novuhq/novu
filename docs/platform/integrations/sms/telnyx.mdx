---
title: "Telnyx SMS Integration with Novu"
sidebarTitle: 'Telnyx'
description: "Connect Telnyx to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using Telnyx, add your Telnyx credentials as an SMS integration in the Novu Dashboard.
