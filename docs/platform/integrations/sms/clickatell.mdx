...
description: "Connect Clickatell to Novu to send SMS notifications through workflows. Store your Clickatell API key and sender ID in the Novu dashboard for global delivery."
---
