---
title: "AWS SNS SMS Integration with Novu"
sidebarTitle: "AWS SNS"
description: "Connect AWS SNS to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using AWS SNS, add your AWS SNS credentials as an SMS integration in the Novu Dashboard.
