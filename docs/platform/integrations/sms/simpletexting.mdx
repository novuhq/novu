---
title: "SimpleTexting SMS Integration with Novu"
sidebarTitle: 'SimpleTexting'
description: "Connect SimpleTexting to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using SimpleTexting, add your SimpleTexting credentials as an SMS integration in the Novu Dashboard.
