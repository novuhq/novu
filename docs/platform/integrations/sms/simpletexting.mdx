...
description: "Connect SimpleTexting to Novu to send SMS notifications through workflows. Store your SimpleTexting API key and account phone in the Novu dashboard."
---
