---
title: "Azure SMS SMS Integration with Novu"
sidebarTitle: "Azure SMS"
description: "Connect Azure SMS to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using Azure SMS, add your Azure SMS credentials as an SMS integration in the Novu Dashboard.
