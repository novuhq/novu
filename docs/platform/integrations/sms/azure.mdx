...
description: "Connect Azure Communication Services SMS to Novu to send SMS notifications through workflows using an Azure connection string and provisioned phone numbers."
---
