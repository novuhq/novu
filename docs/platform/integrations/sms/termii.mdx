...
sidebarTitle: 'Termii'
description: "Connect Termii to Novu to send SMS notifications through workflows. Store your Termii API key and sender ID in the Novu dashboard for delivery across Africa."
---
