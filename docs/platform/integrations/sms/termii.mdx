---
title: "Termii SMS Integration with Novu"
sidebarTitle: 'Termii'
description: "Connect Termii to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using Termii, add your Termii credentials as an SMS integration in the Novu Dashboard.
