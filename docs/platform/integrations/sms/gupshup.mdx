...
description: "Connect Gupshup SMS to Novu to send SMS notifications through workflows. Store your Gupshup user ID, password, and source in the Novu dashboard for delivery."
---
