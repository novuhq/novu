...
description: "Connect Kudosity (formerly Burst SMS) to Novu to send SMS notifications through workflows. Store your Kudosity username and password in the Novu dashboard."
---
