---
title: "Kudosity SMS Integration with Novu"
sidebarTitle: 'Kudosity'
description: "Connect Kudosity to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using Kudosity, add your Kudosity credentials as an SMS integration in the Novu Dashboard.
