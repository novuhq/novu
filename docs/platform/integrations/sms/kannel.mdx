...
sidebarTitle: 'Kannel'
description: "Connect Kannel to Novu to send SMS notifications through workflows using an open-source SMS gateway. Configure the Kannel host and credentials in the dashboard."
---
