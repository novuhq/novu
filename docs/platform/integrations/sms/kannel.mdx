---
title: "Kannel SMS Integration with Novu"
sidebarTitle: 'Kannel'
description: "Connect Kannel to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using Kannel, add your Kannel credentials as an SMS integration in the Novu Dashboard.
