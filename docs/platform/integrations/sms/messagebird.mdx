...
description: "Connect MessageBird (Bird) to Novu to send SMS notifications through workflows. Store your MessageBird access key and sender ID in the Novu dashboard."
---
