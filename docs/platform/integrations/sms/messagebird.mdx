---
title: "MessageBird SMS Integration with Novu"
sidebarTitle: 'MessageBird'
description: "Connect MessageBird to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using MessageBird, add your MessageBird credentials as an SMS integration in the Novu Dashboard.
