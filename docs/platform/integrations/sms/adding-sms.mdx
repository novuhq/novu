...
description: "Connect Adding SMS Channel to Novu to send SMS notifications through notification workflows. Step-by-step credential setup."
---

To send SMS notifications through Novu using Adding SMS Channel, add your Adding SMS Channel credentials as an SMS integration in the Novu Dashboard.
