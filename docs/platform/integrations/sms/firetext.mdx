...
description: "Connect Firetext to Novu to send SMS notifications through workflows. Store your Firetext API key and sender ID in the dashboard for UK-focused SMS delivery."
---
