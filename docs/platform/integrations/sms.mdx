...
- Selects the correct provider. See [Integration conditions](/platform/integrations/integration-conditions).
...
By default, Novu uses your primary SMS provider. To route automatically from subscriber or context data, see [Integration conditions](/platform/integrations/integration-conditions). To force a specific, active integration for a trigger, then use the `integrationIdentifier`.
...
<Card title="Nexmo" href="/platform/integrations/sms/nexmo"> Learn how to use the Nexmo (Vonage) provider to send SMS notifications using Novu.</Card>
...
<Card title="CM.com" href="/platform/integrations/sms/cm-com"> Learn how to use the CM.com provider to send SMS notifications using Novu.</Card>
...
<Card title="Bandwidth" href="/platform/integrations/sms/bandwidth"> Learn how to use the Bandwidth provider to send SMS notifications using Novu.</Card>
<Card title="RingCentral" href="/platform/integrations/sms/ring-central"> Learn how to use the RingCentral provider to send SMS notifications using Novu.</Card>
...
<Card title="Brevo - SMS" href="/platform/integrations/sms/brevo"> Learn how to use the Brevo SMS provider to send SMS notifications using Novu.</Card>
...
<Card title="Unifonic" href="/platform/integrations/sms/unifonic"> Learn how to use the Unifonic provider to send SMS notifications using Novu.</Card>
...
<Card title="Maqsam" href="/platform/integrations/sms/maqsam"> Learn how to use the Maqsam provider to send SMS notifications using Novu.</Card>
<Card title="Mobishastra" href="/platform/integrations/sms/mobishastra"> Learn how to use the Mobishastra provider to send SMS notifications using Novu.</Card>
<Card title="Afro Message" href="/platform/integrations/sms/afro-message"> Learn how to use the Afro Message provider to send SMS notifications using Novu.</Card>
<Card title="smsmode" href="/platform/integrations/sms/smsmode"> Learn how to use the smsmode provider to send SMS notifications using Novu.</Card>
<Card title="iSend SMS" href="/platform/integrations/sms/isend-sms"> Learn how to use the iSend SMS provider to send SMS notifications using Novu.</Card>
<Card title="iSendPro" href="/platform/integrations/sms/isendpro"> Learn how to use the iSendPro provider to send SMS notifications using Novu.</Card>
<Card title="iMedia" href="/platform/integrations/sms/imedia"> Learn how to use the iMedia provider to send SMS notifications using Novu.</Card>
<Card title="Eazy" href="/platform/integrations/sms/eazy"> Learn how to use the Eazy provider to send SMS notifications using Novu.</Card>
<Card title="Ruach SMS" href="/platform/integrations/sms/ruach-sms"> Learn how to use the Ruach SMS provider to send SMS notifications using Novu.</Card>
