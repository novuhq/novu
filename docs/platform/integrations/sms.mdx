...
<Note>
  **RCS is not supported.** Novu does not offer RCS (Rich Communication Services) as a channel or provider integration. The SMS channel delivers standard text messages through the [supported providers](/platform/integrations/sms#supported-providers) listed on this page.
</Note>
