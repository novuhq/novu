...
description: "Connect Pushpad to Novu to send web push notifications through workflows. Store your Pushpad project ID and auth token in the Novu dashboard for delivery."
---
