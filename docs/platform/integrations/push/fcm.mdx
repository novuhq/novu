...
sidebarTitle: 'FCM'
description: "Connect Firebase Cloud Messaging (FCM) to Novu to send push notifications to Android, iOS, and web through workflows using a Firebase service account key."
---
