...
description: "Manually forward push notification delivery, open, and dismissal events from your mobile or web app to Novu for unified activity tracking across channels."
---
