...
description: "Connect a push webhook provider to Novu to deliver push notifications through your own HTTP endpoint or a custom push gateway using a webhook URL and headers."
---
