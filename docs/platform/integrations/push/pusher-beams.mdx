...
description: "Connect Pusher Beams to Novu to send push notifications to iOS, Android, and web devices through workflows using your Pusher Beams instance ID and secret key."
---
