...
description: "Learn how Novu's default demo Email and SMS providers work, their sending limits, and when to replace them with your own production integrations."
---
