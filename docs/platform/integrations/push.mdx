...
All push providers — FCM, APNS, Expo, OneSignal, Pushpad, Push Webhook, Pusher Beams, and AppIO — use the same unvalidated escape hatch. There is no schema autocomplete: whatever JSON object you save is merged into that provider's outbound payload as-is.
