...
description: "Connect Mailjet to Novu to send transactional emails through workflows. Store your Mailjet API key and secret in the dashboard for verified-sender delivery."
---
