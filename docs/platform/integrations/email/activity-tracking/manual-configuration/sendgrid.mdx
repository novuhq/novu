---
title: 'SendGrid'
description: "Manually configure SendGrid event webhooks so Novu can track delivered, opened, clicked, bounced, and spam-report events for outbound transactional emails."
---
