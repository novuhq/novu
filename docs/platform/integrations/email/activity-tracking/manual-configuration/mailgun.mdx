---
title: 'Mailgun'
description: "Manually add event webhooks in the Mailgun dashboard so Novu can track delivered, opened, clicked, bounced, and complained events for your email messages."
---
