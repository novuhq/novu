---
title: 'Amazon SES'
description: "Manually configure Amazon SES with SNS notifications so Novu can track delivered, bounced, complained, and opened events for outbound transactional emails."
---
...
7. Paste the name into the **Configuration Set Name** field in the SES integration credentials form. This is a first-class credential field, so you do not need to enable the **Email Activity Tracking** toggle to set it.
