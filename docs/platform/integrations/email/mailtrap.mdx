...
description: "Connect Mailtrap to Novu to send transactional emails through workflows. Great for staging and testing with Mailtrap's inbox capture and email sandbox."
---
