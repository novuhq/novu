---
title: "Infobip Email Integration with Novu"
sidebarTitle: 'Infobip'
description: "Connect Infobip to Novu to send email notifications through notification workflows. Step-by-step credential setup."
---

To send email notifications through Novu using Infobip, add your Infobip credentials as an email integration in the Novu Dashboard.
