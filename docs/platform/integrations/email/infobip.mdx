...
description: "Connect Infobip Email to Novu to send transactional emails through workflows. Store your Infobip API key and base URL, then map senders for reliable delivery."
---
