---
title: "Sparkpost Email Integration with Novu"
sidebarTitle: 'Sparkpost'
description: "Connect Sparkpost to Novu to send email notifications through notification workflows. Step-by-step credential setup."
---

To send email notifications through Novu using Sparkpost, add your Sparkpost credentials as an email integration in the Novu Dashboard.
