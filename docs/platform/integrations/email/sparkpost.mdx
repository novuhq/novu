...
description: "Connect SparkPost to Novu to send transactional emails through workflows. Store your SparkPost API key, region, and verified sending domain in the dashboard."
---
