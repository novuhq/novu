---
title: "Plunk Email Integration with Novu"
sidebarTitle: 'Plunk'
description: "Connect Plunk to Novu to send email notifications through notification workflows. Step-by-step credential setup."
---

To send email notifications through Novu using Plunk, add your Plunk credentials as an email integration in the Novu Dashboard.
