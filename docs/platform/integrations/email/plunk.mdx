...
sidebarTitle: 'Plunk'
description: "Connect Plunk to Novu to send transactional emails through workflows. Store your Plunk API key in the Novu dashboard and deliver via Plunk's sending API."
---
