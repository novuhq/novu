...
description: "Connect MailerSend to Novu to send transactional emails through workflows. Store your MailerSend API token and verified domain sender in the Novu dashboard."
---
