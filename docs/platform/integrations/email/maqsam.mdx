...
sidebarTitle: 'Maqsam'
description: "Connect Maqsam to Novu to send transactional emails through workflows. Store your Maqsam credentials in the Novu dashboard and deliver via Maqsam's sending API."
---
