...
description: "Connect an email webhook provider to Novu to send transactional emails through your own HTTP API or a custom email service using a webhook URL and headers."
---
