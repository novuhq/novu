...
description: "Connect Netcore (Pepipost) to Novu to send transactional emails through workflows. Store your Netcore API key and verified sender in the Novu dashboard."
---
