...
<Note>
  **Not the same as receiving email replies.** Activity tracking listens to your **outbound email provider** for delivery and engagement events (delivered, opened, clicked, bounced). To receive **inbound mail from users**, use [Inbound Email](/platform/inbound-email/overview) or [agent email](/agents/get-started/agents-and-providers).
</Note>
