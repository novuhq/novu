...
sidebarTitle: 'Resend'
description: "Connect Resend to Novu to send transactional emails through workflows. Store your Resend API key and verified sending domain in the Novu dashboard for delivery."
---
