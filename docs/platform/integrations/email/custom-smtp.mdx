...
description: "Connect a custom SMTP server to Novu to send transactional emails through workflows. Configure host, port, TLS, and credentials for any SMTP provider."
---
