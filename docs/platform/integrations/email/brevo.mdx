...
sidebarTitle: 'Brevo'
description: "Connect Brevo (formerly Sendinblue) to Novu to send transactional emails through workflows. Store your Brevo API key and verified sender in the Novu dashboard."
---
