---
title: "Brevo Email Integration with Novu"
sidebarTitle: 'Brevo'
description: "Connect Brevo to Novu to send email notifications through notification workflows. Step-by-step credential setup."
---

To send email notifications through Novu using Brevo, add your Brevo credentials as an email integration in the Novu Dashboard.
