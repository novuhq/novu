---
title: 'How to Write Email Templates in Novu'
sidebarTitle: 'Writing Email Template'
description: 'Create email templates in Novu using the block editor, custom HTML with LiquidJS, or the API. Personalize content with subscriber and payload variables.'
---
