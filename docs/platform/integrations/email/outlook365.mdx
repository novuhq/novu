...
description: "Connect Outlook 365 to Novu to send transactional emails through workflows using your Microsoft 365 mailbox credentials, OAuth settings, and SMTP configuration."
---
