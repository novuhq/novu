---
title: "Postmark Email Integration with Novu"
sidebarTitle: 'Postmark'
description: "Connect Postmark to Novu to send email notifications through notification workflows. Step-by-step credential setup."
---

To send email notifications through Novu using Postmark, add your Postmark credentials as an email integration in the Novu Dashboard.
