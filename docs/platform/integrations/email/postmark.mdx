...
description: "Connect Postmark to Novu to send transactional emails through workflows. Store your Postmark server token and verified sender signature in the Novu dashboard."
---
