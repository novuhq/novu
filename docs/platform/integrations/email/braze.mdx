...
sidebarTitle: 'Braze'
description: "Connect Braze to Novu to send transactional emails through workflows. Store your Braze API key and endpoint, then deliver via the Braze transactional API."
---
