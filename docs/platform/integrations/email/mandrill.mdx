...
description: "Connect Mandrill (Mailchimp Transactional) to Novu to send transactional emails through workflows. Store your Mandrill API key and verified sender."
---
