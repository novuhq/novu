---
title: "Mandrill Email Integration with Novu"
sidebarTitle: 'Mandrill'
description: "Connect Mandrill to Novu to send email notifications through notification workflows. Step-by-step credential setup."
---

To send email notifications through Novu using Mandrill, add your Mandrill credentials as an email integration in the Novu Dashboard.
