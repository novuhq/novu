---
title: "Amazon SES Email Integration with Novu"
sidebarTitle: "Amazon SES"
description: "Connect Amazon SES to Novu to send transactional emails through workflows. Configure IAM credentials, verified sender identities, and the SES region."
---
...
- Optionally, set a **Configuration Set Name** to apply an [SES configuration set](https://docs.aws.amazon.com/ses/latest/dg/using-configuration-sets.html) to every email Novu sends through this integration. Leave it empty if you don't use configuration sets. This value is required to enable [Email Activity Tracking](/platform/integrations/email/activity-tracking/manual-configuration/ses).
