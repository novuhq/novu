...
description: "Connect Amazon SES to Novu to send email notifications through notification workflows. Step-by-step credential setup."
---

To send email notifications through Novu using Amazon SES, add your Amazon SES credentials as an email integration in the Novu Dashboard.
