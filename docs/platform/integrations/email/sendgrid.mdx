...
description: "Connect SendGrid to Novu to send transactional emails through workflows. Store your SendGrid API key and verified sender identity in the Novu dashboard."
---
