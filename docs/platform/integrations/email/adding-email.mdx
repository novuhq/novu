...
description: "Connect Adding Email Channel to Novu to send email notifications through notification workflows. Step-by-step credential setup."
---

To send email notifications through Novu using Adding Email Channel, add your Adding Email Channel credentials as an email integration in the Novu Dashboard.
