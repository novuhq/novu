---
title: "Adding Email Channel Email Integration with Novu"
sidebarTitle: "Adding Email Channel"
description: "Add an email channel provider in Novu to send transactional emails through workflows. Covers selecting a provider, storing credentials, and testing delivery."
---
...
5. (Optional) Add [integration conditions](/platform/integrations/integration-conditions) if this provider should only send when those rules match.
6. Click **"Create"**
