...
<Note>
  **SMS replies are not supported** in Novu. See [Handling channel replies](/platform/handling-replies) for the full channel matrix.
</Note>

<Columns cols={2}>
  <Card icon="reply" href="/platform/handling-replies" title="Handling channel replies">
    Compare reply options across email, chat, and SMS.
  </Card>
