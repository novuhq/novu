...
description: "Apply contexts in Novu workflows to personalize notification templates, control workflow logic, and customize per-tenant behavior in the Inbox."
---
