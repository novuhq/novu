---
title: 'HTTP Step'
description: "Use the HTTP step in Novu workflows to call external APIs, enrich payloads with response data, and coordinate side effects with the rest of your workflow."
---
