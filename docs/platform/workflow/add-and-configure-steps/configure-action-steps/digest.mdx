---
title: 'Digest Step'
description: "Batch multiple Novu workflow trigger events into a single execution with the digest step using configurable time windows and grouping rules."
---
