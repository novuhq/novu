---
title: 'Throttle Step'
description: "Use the throttle step in Novu workflows to cap notification frequency per subscriber, per workflow, and prevent spam during high-traffic events."
---
