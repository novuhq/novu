...
A <GlossaryTerm term="workflow">workflow</GlossaryTerm> defines how Novu delivers notifications for a specific event. It contains the <GlossaryTerm term="step">steps</GlossaryTerm>, templates, and rules that control how messages are sent across channels.
