---
title: Agent Skills
description: "Use Novu Agent Skills to help AI coding assistants build multi-channel notification systems in your codebase, with guided prompts and reusable patterns."
---
