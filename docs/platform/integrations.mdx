...
<GlossaryTerm term="provider">Providers</GlossaryTerm> are the third-party services that deliver your notifications through the various <GlossaryTerm term="channel">channels</GlossaryTerm>. These are services such as SendGrid for email, Twilio for SMS, or Slack for chat.
...
- **Integration**: An <GlossaryTerm term="integration">integration</GlossaryTerm> is your specific, configured instance of that provider. It's the provider plus your unique credentials and settings. When creating an integration, you are required to assign it a name and identifier. 
