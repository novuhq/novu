---
title: 'Notification Channel Providers and Integrations'
...
<Tooltip headline="Provider" tip="A third-party service that delivers notifications on a channel, such as SendGrid for email or Twilio for SMS." cta="Learn more" href="/platform/concepts/integrations">Providers</Tooltip> are the third-party services that deliver your notifications through the various <Tooltip headline="Channel" tip="A communication medium used to deliver notifications: in-app (Inbox), email, SMS, push, or chat." cta="Learn more" href="/platform/integrations">channels</Tooltip>. These are services such as SendGrid for email, Twilio for SMS, or Slack for chat.
...
- **Integration**: An <Tooltip headline="Integration" tip="An environment-scoped, configured connection to a third-party provider with credentials and channel settings." cta="Learn more" href="/platform/concepts/integrations">integration</Tooltip> is your specific, configured instance of that provider. It's the provider plus your unique credentials and settings. When creating an integration, you are required to assign it a name and identifier. 
...
![Integration identifier field in the Novu Dashboard for naming a provider connection](/images/channels-and-providers/integrationidentifier.png)
...
![Primary and active integration settings in the Novu Dashboard channel configuration](/images/channels-and-providers/primary-active-integrations.png)
