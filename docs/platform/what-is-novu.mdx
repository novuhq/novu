---
title: What is Novu?
description: 'Learn how Novu delivers multi-channel notifications with workflows, a drop-in Inbox component, and 60+ provider integrations. Open source.'
---
...
<Columns cols={2}>
  <Card icon="rocket" href="/platform/quickstart/nextjs" title="Quickstart">Get started in minutes and focus on building, not maintaining notifications. </Card>
</Columns>
...
<AccordionGroup>
  <Accordion title="What makes Novu different from other notification platforms?">
    Novu is fully open source, supports both no-code workflows and code-first workflows with the Novu Framework, and includes a drop-in Inbox component for in-app notifications with headless customization options.
  </Accordion>
