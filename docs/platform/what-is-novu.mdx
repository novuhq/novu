---
title: What is Novu?
description: The open-source communication infrastructure for transactional notifications and agent conversations across in-app, email, chat, push, and SMS.
---
...
<Columns cols={2}>
  <Card icon="git-branch" href="/agents/get-started/what-is-aci" title="What is ACI?">
