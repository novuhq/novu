...
<Columns cols={2}>
  ...
  <Card icon="zap" href="/agents/get-started/claude-managed" title="Agents quickstart">
...
Workflows can send messages on behalf of an agent across email, chat, and other channels. Assign the agent on the workflow (or override it per trigger). When a subscriber replies, Novu opens an agent conversation and hydrates the original notification onto the turn. See [Workflow-assigned agents](/agents/workflow-agents).
...
Learn more in [Workflow-assigned agents](/agents/workflow-agents), [Conversations and workflows](/agents/custom-code-agent/concepts#conversations-and-workflows), and [Signals](/agents/custom-code-agent/building-blocks/signals).
...
<Columns cols={2}>
  ...
  <Card
    ...
    href="/agents/get-started/claude-managed"
