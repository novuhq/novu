---
title: 'SAML SSO & SCIM'
description: "Enable SAML SSO, OIDC, and SCIM directory sync for your Novu organization to centrally manage identity, access, and user provisioning from your IdP."
---
