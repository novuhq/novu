...
Novu is the open-source notification infrastructure for sending, receiving, and tracking notifications across in-app, email, SMS, push, and chat <GlossaryTerm term="channel">channels</GlossaryTerm>. Use <GlossaryTerm term="workflow">workflows</GlossaryTerm> to orchestrate delivery, the <GlossaryTerm term="inbox">Inbox component</GlossaryTerm> for real-time in-app notifications, and [60+ provider integrations](/platform/integrations) for external channels.
