...
New to Novu? Start with [What is Novu?](/platform/what-is-novu) or add the Inbox to your app with the [Next.js](/platform/quickstart/nextjs) or [Svelte](/platform/quickstart/svelte) quickstart.
...
<Columns cols={4}>
  ...
  <Card title="Svelte Quickstart" icon="/images/icons/svelte.svg" href="/platform/quickstart/svelte">
    Add the native Novu Inbox component to a Svelte or SvelteKit app.
  </Card>
...
<Columns cols={4}>
  ...
  <Card title="Svelte" icon="/images/icons/svelte.svg" href="/platform/quickstart/svelte">
    Official Svelte SDK for Novu's Inbox component.
  </Card>
