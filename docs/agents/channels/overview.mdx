...
| Outbound quote-reply | Plain post | Plain post | Native | Native | — | — |
| Inbound quote context (`replyTo`) | Not yet | Yes | Yes | Yes | — | — |
...
On channels without native outbound quote-reply, Novu sends a normal post and logs at debug level. No error is returned.
