...
Use Microsoft Teams as a messaging channel for your agent. Novu keeps conversation context, shows typing during the turn, can update a plan card in place, and posts Adaptive Card approvals for gated tools.
