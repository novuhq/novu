---
title: "Reply"
description: 'Send plain text, markdown, file attachments, and interactive cards from custom-code agent handlers with ctx.reply() on the reply contract.'
---
...
To change a message after you send it, see [Edit sent messages](/agents/custom-code-agent/setup-your-agent/edit-sent-messages). To remove a rendered message from the platform, see [Delete sent messages](/agents/custom-code-agent/setup-your-agent/delete-sent-messages).
