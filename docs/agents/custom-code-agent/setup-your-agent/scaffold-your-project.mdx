...
description: "Generate a Novu agent bridge project with the CLI, install dependencies, and connect the local application to your dashboard agent in a few minutes."
---
