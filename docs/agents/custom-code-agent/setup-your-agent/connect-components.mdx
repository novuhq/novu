...
<!-- prompt-source: snippets/prompts/agents/slack-connect-button.mdx -->
...
Context: I'm already signed in to the Novu dashboard and the Slack integration already exists. This is purely a frontend code integration — do NOT run the Novu CLI, the agent-onboarding flow, or keyless mode.
...
<!-- prompt-source: snippets/prompts/agents/telegram-connect-button.mdx -->
