---
title: "Custom Code Agent Setup Overview"
description: "Configure a Novu custom code agent end to end: dashboard settings, bridge endpoint, connected providers, and the handler code that powers the agent brain."
...
<Columns cols={2}>
  ...
  <Card icon="code" href="/api-reference/agents/agent-schema" title="Agents API reference">
    Create agents, link providers, and update bridge URLs with the REST API.
  </Card>
</Columns>
