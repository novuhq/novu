---
title: "Concepts"
description: "Understand the entities, lifecycle, and handler building blocks that make up a Novu custom code agent, from bridge endpoints to event handlers."
---
