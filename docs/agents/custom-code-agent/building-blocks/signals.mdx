---
title: "Signals"
description: "Use signals in custom code agent handlers to update metadata, trigger Novu workflows, and mark conversations resolved from your agent runtime."
---
...
| Metadata / trigger signals | Yes | Yes | Yes | Yes | Yes |

Resolve and other signals are channel-agnostic. Novu applies them to the conversation regardless of provider. See [Channels overview](/agents/channels/overview).
