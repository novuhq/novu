...
Client walk: [Custom data](/agents/channels/web-chat/generative-ui#custom-data).
...
<Columns cols={2}>
  ...
  <Card icon="list" href="/agents/channels/web-chat/generative-ui#custom-data" title="Web Chat data parts">
