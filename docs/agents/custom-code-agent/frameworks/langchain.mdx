...
On Next.js, model strings need LangChain listed in `serverExternalPackages` — see [Next.js and Turbopack](#nextjs-and-turbopack). `npx novu connect --runtime langchain` configures this for you.
