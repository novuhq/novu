---
title: "Other frameworks reference"
description: "API patterns for @novu/framework with any LLM stack: OpenAI SDK, Anthropic SDK, Mastra, or custom code."
sidebarTitle: Other
---


Already connecting an agent? For Mastra, start with [Connect Mastra to Slack](/agents/get-started/mastra). This page is the generic Framework API for stacks without a dedicated Novu adapter.
...
Completed a [connect guide](/agents/get-started/mastra)? Your agent, bridge, and project are already set up - [jump to Minimal agent](#minimal-agent).
