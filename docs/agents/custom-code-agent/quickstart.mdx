---
title: "Quickstart"
description: "Build your first Novu custom code agent and connect it to Slack in under 10 minutes. Set up the bridge, define handlers, and reply to messages."
boost: 3
---
