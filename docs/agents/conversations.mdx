...
description: "View, inspect, and manage agent conversations in the Novu dashboard, including lifecycle state, message history, metadata, and per-channel activity."
---
...
<Note>
  Platform capabilities vary. For example, typing indicators and message edits are unavailable on email, and outbound file sharing is not supported on any live channel yet.
</Note>
