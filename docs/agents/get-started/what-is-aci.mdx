...
That means you can connect an agent your team uses internally, expose an agent to your product users, or put a customer-facing agent in the channels your customers already use.
...
Follow a connect guide to wire an existing agent (or scaffold a starter) to Slack and send your first message.

<Columns cols={2}>
  <Card
    href="/agents/get-started/ai-sdk"
    title="Connect AI SDK"
    icon="plug"
  >
  Connect a Vercel AI SDK agent to Slack.
  </Card>
  <Card
    href="/agents/channels/overview"
    title="Channels overview"
    icon="table"
  >
  See what Slack, Teams, WhatsApp, Telegram, email, and Web Chat support.
  </Card>
</Columns>
