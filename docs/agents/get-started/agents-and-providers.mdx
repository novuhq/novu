...
description: "How Novu agents and provider connections route messages, resolve identity, and deliver replies across supported channels."
---
...
Each agent has a name, an identifier, and a set of event handlers that define how your application responds to conversation events. An agent can be connected to one or more providers, such as Slack, Microsoft Teams, WhatsApp, email, or in-app Web Chat.
...
- [Slack](/agents/channels/slack)
- [Microsoft Teams](/agents/channels/microsoft-teams)
- [WhatsApp](/agents/channels/whatsapp)
- [Telegram](/agents/channels/telegram)
- [Email](/agents/channels/email)
- [Web Chat](/agents/channels/web-chat)
