...
You can manage managed agents programmatically with the [Agents API reference](/api-reference/agents/agent-schema):

<Columns cols={2}>
  <Card
    title="Create an agent"
    href="/api-reference/agents/create-an-agent"
    description="Create a managed agent in the current environment"
  />
  <Card
    title="Generate an agent configuration"
    href="/api-reference/agents/generate-an-agent-configuration"
    description="Generate system prompt, tools, and MCP settings from a description"
  />
  <Card
    title="Update runtime config"
    href="/api-reference/agents/update-an-agent-runtime-config"
    description="Update system prompt, connector credentials, and runtime settings"
  />
  <Card
    title="Upload custom skills"
    href="/api-reference/agents/upload-custom-skills"
    description="Upload SKILL.md files to the AI platform"
  />
  <Card
    title="List MCP servers"
    href="/api-reference/agents/list-agent-mcp-servers"
    description="List MCP servers configured on an agent"
  />
  <Card
    title="Enable an MCP server"
    href="/api-reference/agents/enable-an-agent-mcp-server"
    description="Enable an MCP server on a managed agent"
  />
</Columns>
