...
You can also [upload custom skills](/api-reference/agents/upload-custom-skills) with the REST API.
...
<Columns cols={2}>
  ...
  <Card icon="code" href="/api-reference/agents/upload-custom-skills" title="Upload custom skills API">
    Upload SKILL.md files programmatically.
  </Card>
</Columns>
