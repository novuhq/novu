...
This guide walks you through creating a managed <GlossaryTerm term="agent">agent</GlossaryTerm> using the Novu CLI, connecting it to Slack, and sending your first message.
