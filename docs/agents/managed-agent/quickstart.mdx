---
title: "Quickstart"
description: "Use the Novu CLI to create a managed agent, connect it to Slack, install MCP tools, and get your first AI-powered reply flowing in minutes."
---


This guide walks you through creating a managed <Tooltip headline="Agent" tip="An AI-powered entity connected to messaging channels through Novu Connect, with custom code or managed configuration." cta="Learn more" href="/agents">agent</Tooltip> using the Novu CLI, connecting it to Slack, and sending your first message.
...
<Note>
  The CLI uses the same REST APIs under the hood. To create agents programmatically, see [Create an agent](/api-reference/agents/create-an-agent). Managed runtime configuration is done from the dashboard.
</Note>
