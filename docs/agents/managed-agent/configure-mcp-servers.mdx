...
description: "Enable external tools like Linear, GitHub, and Notion on your Novu managed agent by configuring MCP servers in the dashboard for tool-augmented replies."
---
...
<Columns cols={2}>
  ...
  <Card icon="code" href="/api-reference/agents/list-agent-mcp-servers" title="MCP servers API">
    Enable, replace, or disable MCP servers programmatically.
  </Card>
</Columns>
