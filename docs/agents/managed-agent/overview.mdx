...
description: "Learn how Novu managed agents work with Claude out of the box, and when to choose a fully managed agent brain over a custom code agent with Novu Connect."
