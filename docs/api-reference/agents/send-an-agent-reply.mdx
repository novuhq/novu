...
description: "Post a message or side-effect into an existing agent conversation from your backend. Supports markdown, cards, files, edits, reactions, typing, signals, tool results, and resolution."
