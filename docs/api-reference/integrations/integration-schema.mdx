...
| `primary` | `boolean` | For email and SMS, the default integration when no conditioned integration is selected. An integration cannot be primary if it has `rules`. |
