---
title: 'Idempotency'
description: "Use idempotency keys with the Novu API to safely retry POST and PATCH requests without triggering duplicate workflow runs or duplicate side effects."
---
