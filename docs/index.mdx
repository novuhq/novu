...
<Columns cols={2}>
  <Card title="Start with Connect" img="/images/docs-home-card-agents.svg" href="/connect">
    **You already have an agent.** Connect it to the channels your customers use — Slack, iMessage, MS Teams, WhatsApp — with the AI SDK.
  </Card>
  <Card title="Start with Notify" img="/images/docs-home-card-platform.svg" href="/notify">
