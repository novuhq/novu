---
title: 'Nuxt'
description: "Get started with Novu Framework in a Nuxt application by scaffolding a server route, defining a workflow, and triggering your first notification."
---
