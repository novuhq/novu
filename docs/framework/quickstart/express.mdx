...
In this guide, we will add a Novu <GlossaryTerm term="bridge">Bridge Endpoint</GlossaryTerm> to a Express.js application and send our first test <GlossaryTerm term="workflow">workflow</GlossaryTerm>.
