...
description: "Deploy your Novu Framework bridge to production with guidance on networking, secrets, HMAC verification, timeouts, and monitoring for reliability."
---
...
<Note>
  ...
  (via `npx novu dev`) can reach your endpoint.
</Note>
