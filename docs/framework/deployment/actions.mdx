...
description: "Deploy Novu Framework workflows automatically from GitHub with the official Novu Sync action to keep production in sync with your repository."
---
