---
title: 'Client'
description: "Configure the Novu Framework Client for global settings like API URL, secret key, strict authentication, and payload logging in your bridge app."
---
...
- **Description**: This bypasses the HMAC signature verification, required for [local development](/framework/studio) and testing against the Dashboard's Local environment.
