---
title: 'Email'
description: "Use the email step in Novu Framework to send email notifications with dynamic subject lines, HTML bodies, attachments, and React Email templates."
---
