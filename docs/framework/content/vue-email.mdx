---
title: 'Vue Email'
description: "Design responsive email templates for Novu workflows with Vue Email components and render them from your Framework email step at trigger time."
---
