---
title: 'Svelte Email'
description: "Use Svelte Email components with the Novu Framework to build responsive, reusable transactional email templates in your Svelte or SvelteKit project."
---
