...
description: "Integrate React Email templates with Novu Framework in a Remix application to render rich, responsive transactional emails inside your workflows."
---
