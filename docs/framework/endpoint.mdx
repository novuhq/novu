...
Novu Framework requires a **single** `HTTP` endpoint (`/api/novu` or similar) to be exposed by your application. This <GlossaryTerm term="bridge">Bridge Endpoint</GlossaryTerm> is used to receive events from our **Worker Engine**.
