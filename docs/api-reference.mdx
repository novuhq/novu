...
- **Versioned paths** — The API version is part of the URL (`/v1`, `/v2`). See [Versioning](/api-reference/versioning).
...
<Columns cols={2}>
  ...
  <Card title="Pagination" icon="list" href="/api-reference/pagination">
    Page through large list responses with page, offset, and cursor pagination.
  </Card>
  <Card title="Versioning" icon="git-compare" href="/api-reference/versioning">
    How v1 and v2 endpoints work and how deprecations are communicated.
  </Card>
</Columns>
...
<Steps>
  ...
  <Step title="Review API policies">
    Understand [Errors](/api-reference/errors), [Pagination](/api-reference/pagination), [Rate limiting](/api-reference/rate-limiting), [Idempotency](/api-reference/idempotency), [Versioning](/api-reference/versioning), and [Payload limits](/api-reference/payload-limits) before building production integrations.
  </Step>
</Steps>
