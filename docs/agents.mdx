...
Novu Connect is built on the <GlossaryTerm term="aci">Agent Communication Infrastructure (ACI)</GlossaryTerm>, the infrastructure layer that handles how agents communicate, so your agents can hold real conversations across messaging platforms with users, on the channels they already use.
...
Novu Connect accepts two kinds of <GlossaryTerm term="agent-brain">agent brains</GlossaryTerm>. You choose how you want to bring it.
