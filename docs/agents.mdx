...
description: "Connect AI agents to Slack, Teams, WhatsApp, and email with Novu's Agent Communication Infrastructure. Route messages, preserve context, and deliver replies."
...
Write your own agent logic. Handle events, call any LLM or API, and reply using the Novu agent SDK. Compatible with AI SDK, LangChain, Mastra, OpenAI SDK, and any custom code of your choosing.

<Columns cols={3}>
  <Card href="/agents/get-started/ai-sdk" title="AI SDK" icon="sparkles">
    Build with the Vercel AI SDK and `@novu/framework/ai-sdk`.
  </Card>
  <Card href="/agents/get-started/langchain" title="LangChain" icon="link">
    Build with LangChain and `@novu/framework/langchain`.
  </Card>
  <Card href="/agents/get-started/mastra" title="Mastra" icon="boxes">
    Build with Mastra and `@novu/framework`.
  </Card>
</Columns>
...
<Columns cols={2}>
  <Card href="/agents/get-started/ai-sdk" title="AI SDK quickstart" icon="sparkles">
    Connect an AI SDK agent to Slack, Teams, WhatsApp, Telegram, or email.
  </Card>
  <Card href="/agents/get-started/langchain" title="LangChain quickstart" icon="link">
    Connect a LangChain agent to your messaging channels.
  </Card>
  <Card href="/agents/get-started/mastra" title="Mastra quickstart" icon="boxes">
    Connect a Mastra agent to your messaging channels.
  </Card>
  <Card href="/agents/managed-agent/quickstart" title="Managed agent quickstart" icon="sparkles">
...
<Columns cols={2}>
  ...
  <Card href="/agents/get-started/ai-sdk" title="AI SDK quickstart" icon="zap">
  ...
  <Card href="/api-reference/agents/agent-schema" title="Agents API reference" icon="code">
