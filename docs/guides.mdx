...
description: "Step-by-step Novu integration guides for Clerk, Stripe, Segment, Hightouch, Auth0, Supabase, and other services to add notifications to your product stack."
