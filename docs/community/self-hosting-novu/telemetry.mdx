---
title: 'Telemetry'
description: "Learn what telemetry data Novu collects from self-hosted deployments, why it is gathered, and how to disable it with an environment variable."
---
