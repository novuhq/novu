---
title: 'Roadmap'
description: "Explore Novu's public roadmap covering upcoming features, in-progress work, and how to propose ideas that shape the notification infrastructure."
---
