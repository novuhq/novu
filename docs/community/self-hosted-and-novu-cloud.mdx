...
description: "Compare Novu Cloud and self-hosted Novu across features, scalability, compliance, and operations to choose the right deployment model for your team."
---
...
| Features | Community Self-Hosted | Novu Cloud |
| ---------- | ---------- | ----------------------- |
| Email activity tracking (delivery and engagement events) | ❌ | ✅ |
| Remove Novu branding | ❌ | ✅ |
