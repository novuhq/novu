---
title: 'Get Involved'
description: "Contribute to Novu by filing issues, opening pull requests, writing docs, joining Discord, or helping other users solve notification challenges."
---
