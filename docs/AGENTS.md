...
- Do not use on integration setup pages (Inbox, workflow triggers, webhooks, quickstarts, agent connect buttons)
...
- Use Lucide icons: `bot` (MCP/skills)
- Use `YOUR_*` placeholders for dashboard-specific values when prompts reference them
- Group prompts under an "Example prompts" section on MCP and skills pages
