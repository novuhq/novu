...
import {
  ...
  useContextsCreateMutation
} from "@novu/api/react-query/contextsCreate.js";
```
...
import {
  ...
  invalidateContextsList,
  invalidateAllContextsList,
} from "@novu/api/react-query/contextsList.js";
```
...
import {
  // Mutation hook for triggering the API call.
  useContextsUpdateMutation
} from "@novu/api/react-query/contextsUpdate.js";
```
...
async function run() {
  const result = await novu.contexts.retrieve("<value>", "<id>");
...
async function run() {
  const res = await contextsRetrieve(novu, "<value>", "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
import {
  ...
  // Utilities to invalidate the query cache for this query in response to
  // mutations and other user actions.
  invalidateContextsRetrieve,
  invalidateAllContextsRetrieve,
} from "@novu/api/react-query/contextsRetrieve.js";
```
...
async function run() {
  const result = await novu.contexts.delete("<value>", "<id>");
...
async function run() {
  const res = await contextsDelete(novu, "<value>", "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
import {
  // Mutation hook for triggering the API call.
  useContextsDeleteMutation
} from "@novu/api/react-query/contextsDelete.js";
```
