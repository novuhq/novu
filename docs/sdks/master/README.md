...
import {
  ...
  useTranslationsMasterRetrieve,
  useTranslationsMasterRetrieveSuspense,
  ...
  invalidateTranslationsMasterRetrieve,
  invalidateAllTranslationsMasterRetrieve,
} from "@novu/api/react-query/translationsMasterRetrieve.js";
```
...
import {
  ...
  useTranslationsMasterImportMutation
} from "@novu/api/react-query/translationsMasterImport.js";
```
...
import {
  // Mutation hook for triggering the API call.
  useTranslationsMasterUploadMutation
} from "@novu/api/react-query/translationsMasterUpload.js";
```
