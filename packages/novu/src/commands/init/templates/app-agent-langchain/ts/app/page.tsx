      ...
      <div className={styles.container}>
        ...
        <div className={styles.steps}>
          ...
          <ol>
            ...
            <li>
              Return a <code className={styles.code}>{'{ model, system, tools }'}</code> config from{' '}
              <code className={styles.code}>app/novu/agents/support-agent.tsx</code>, install{' '}
              <code className={styles.code}>langchain</code> + your provider, and set your API key
            </li>
          </ol>
        </div>
