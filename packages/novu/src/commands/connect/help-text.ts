...
Non-interactive (agent / CI) contract:
  ...
  Channel-specific flags:
    ...
    - --channel agent-chat → no extra flags; works with --keyless. Links Agent Chat, prints dashboard Chat tab URL. Embed path writes env vars; scaffold path creates an example app. Use --agent-chat-setup scaffold|embed|skip in --ci (auto-detect when omitted).
