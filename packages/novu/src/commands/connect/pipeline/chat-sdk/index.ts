...
import { CHAT_SDK_PROMPT_FILE_ENV, writeChatSdkAgentPromptFile } from './agent-prompt-file';
...
export async function maybeRunChatSdkTunnel(input: { outcome: ChatSdkConnectOutcome | undefined }): Promise<boolean> {
  const { outcome } = input;
