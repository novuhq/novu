...
/**
 * Half-block ASCII QR for terminal rendering (same approach as `novu connect`):
 * half-blocks give square modules on 2:1 terminal cells and scan reliably.
 */
export function renderQR(text: string, errorCorrectionLevel: 'L' | 'M' | 'Q' | 'H' = 'L'): string {
