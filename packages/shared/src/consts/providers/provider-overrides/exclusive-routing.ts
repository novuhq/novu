 ...
 * Group order is the sole same-layer precedence (see `FCM_ROUTING_KEYS`); callers must not
 * re-break ties so broadcast detection and the send destination stay aligned.
 */
