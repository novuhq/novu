...
export enum FeatureFlagsKeysEnum {
  ...
  /** Use MongoDB aggregation for inbox session severity unread counts (POST /v1/inbox/session). */
  IS_INBOX_SESSION_SEVERITY_AGGREGATION_ENABLED = 'IS_INBOX_SESSION_SEVERITY_AGGREGATION_ENABLED',
