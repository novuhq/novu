...
export enum FeatureFlagsKeysEnum {
  ...
  /** When true (default), integration lookup is scoped to the current environment. When false, integrations may match across environments in the same organization. */
  IS_CROSS_ENVIRONMENT_INTEGRATION_DISABLED = 'IS_CROSS_ENVIRONMENT_INTEGRATION_DISABLED',
