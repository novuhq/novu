...
export enum FeatureFlagsKeysEnum {
  ...
  IS_V2_MESSAGE_DELIVERY_READ_ENABLED = 'IS_V2_MESSAGE_DELIVERY_READ_ENABLED',
  IS_V2_ACTIVE_SUBSCRIBER_TREND_READ_ENABLED = 'IS_V2_ACTIVE_SUBSCRIBER_TREND_READ_ENABLED',
  ...
  IS_V2_INTERACTION_TREND_READ_ENABLED = 'IS_V2_INTERACTION_TREND_READ_ENABLED',
  IS_V2_DELIVERY_TREND_READ_ENABLED = 'IS_V2_DELIVERY_TREND_READ_ENABLED',
  IS_V2_ACTIVE_SUBSCRIBERS_READ_ENABLED = 'IS_V2_ACTIVE_SUBSCRIBERS_READ_ENABLED',
  IS_V2_TOTAL_INTERACTIONS_READ_ENABLED = 'IS_V2_TOTAL_INTERACTIONS_READ_ENABLED',
