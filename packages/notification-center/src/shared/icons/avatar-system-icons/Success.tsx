...
export function Success(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="icon" viewBox="0 0 1024 1024" fill="currentColor" {...props}>
