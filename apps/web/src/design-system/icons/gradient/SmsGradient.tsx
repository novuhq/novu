...
/* eslint-disable */
export function SmsGradient(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg width="31" height="31" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        ...
        stroke="url(#paint0_linear_440_3090)"
        strokeWidth="2"
        strokeLinecap="round"
