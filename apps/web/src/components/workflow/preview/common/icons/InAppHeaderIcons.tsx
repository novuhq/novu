...
export const InAppHeaderIcons = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="96" height="24" fill="none" viewBox="0 0 96 24">
      ...
      <path fill="#3D3D4D" d="M96 12c0 6.627-5.373 12-12 12s-12-5.373-12-12S77.373 0 84 0s12 5.373 12 12z"></path>
      <path
        fill="#828299"
      ...
      <rect width="10.6" height="10.6" x="48.7" y="2.7" stroke="#292933" strokeWidth="1.4" rx="5.3"></rect>
      <path
        fill="#fff"
