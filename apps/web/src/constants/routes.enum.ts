export enum ROUTES {
  ...
  ANY = '/*',
  TEMPLATES_DIGEST_PLAYGROUND = '/workflows/:templateId/digest-playground',
  TEMPLATES_CREATE = '/workflows/create',
  TEMPLATES_EDIT_TEMPLATEID = '/workflows/edit/:templateId',
  TEMPLATES = '/workflows',
