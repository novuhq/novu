  ...
  return (
    <>
      <Route path={ROUTES.SETTINGS} element={isInformationArchitectureEnabled ? <SettingsPage /> : <SettingsPageOld />}>
        ...
        />
        {isInformationArchitectureEnabled && <Route path={ROUTES.API_KEYS} element={<ApiKeysPage />} />}
        {isInformationArchitectureEnabled && <Route path={ROUTES.PROFILE} element={<UserProfilePage />} />}
        {isInformationArchitectureEnabled && <Route path={ROUTES.BRAND_SETTINGS} element={<BrandingPage />} />}
        {/* TODO: replace with actual component */}
        {isInformationArchitectureEnabled && <Route path={ROUTES.ORGANIZATION} element={<OrganizationPage />} />}
        {isInformationArchitectureEnabled && <Route path={ROUTES.TEAM_SETTINGS} element={<TeamPage />} />}
        {isInformationArchitectureEnabled && <Route path={ROUTES.BILLING} element={<BillingPage />} />}
        {isInformationArchitectureEnabled && <Route path={ROUTES.WEBHOOK} element={<WebhookPage />} />}
        {isInformationArchitectureEnabled && <Route path={ROUTES.SECURITY} element={<AccessSecurityPage />} />}
        ...
        <Route
          ...
          element={<Navigate to={isInformationArchitectureEnabled ? ROUTES.PROFILE : ''} replace />}
        />
      </Route>
    </>
  );
