...
export const ToolEnabledProviders = () => {
      ...
      render={({ field }) => (
        <FormItem className="flex w-full flex-col gap-1.5">
          <div className="flex items-center justify-between gap-2">
            <FormLabel tooltip="Leave empty to deliver to all active Tool integrations. Select specific integrations to limit delivery.">
              Enabled Providers
            </FormLabel>
