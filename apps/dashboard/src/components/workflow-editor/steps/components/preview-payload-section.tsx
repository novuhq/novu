...
import { AccordionSectionProps } from '../types/preview-context.types';
import { ACCORDION_STYLES } from '../constants/preview-context.constants';

export function PreviewPayloadSection({ errors, localParsedData, workflow, onUpdate }: AccordionSectionProps) {
  return (
        ...
        <div className="flex items-center gap-0.5">
          ...
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              The data that will be sent to your workflow when triggered. This can include dynamic values and variables.
            </TooltipContent>
          </Tooltip>
        </div>
      </AccordionTrigger>
