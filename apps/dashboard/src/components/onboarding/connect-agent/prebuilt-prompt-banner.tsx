 ...
 */
const PREBUILT_AGENT_PROMPT = `I'm signed in to the Novu dashboard, so use dashboard login (not keyless mode). Add Agent Chat to my app following instructions from this markdown file: https://novu.co/agents.md`;
