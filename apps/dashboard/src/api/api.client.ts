...
const request = async <T>(
  ...
  try {
    // Prevent API calls during region switching to avoid failed requests
    if (apiHostnameManager.isCurrentlyRegionSwitching()) {
      console.log('Blocking API call during region switching');
    }
