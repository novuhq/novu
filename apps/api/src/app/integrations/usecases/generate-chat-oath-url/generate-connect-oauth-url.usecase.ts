...
import { GenerateConnectOauthUrlCommand } from './generate-connect-oauth-url.command';
...
export class GenerateConnectOauthUrl {
  ...
  private async getIntegration(command: GenerateConnectOauthUrlCommand): Promise<IntegrationEntity> {
