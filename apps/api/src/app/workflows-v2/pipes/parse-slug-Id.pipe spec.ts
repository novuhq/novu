...
describe('ParseSlugIdPipe', () => {
  ...
  // TODO: we need to decide if we always have a prefix (wf_) or not
  it.skip('should handle invalid encoded IDs', () => {
  ...
  it('should trim prefix and decode base62 encoded internalId', () => {
    const internalId = '6615943e7ace93b0540ae377';
  ...
  it('should trim, decode, and remove prefix for a valid slug ID', () => {
    const internalId = '6615943e7ace93b0540ae377';
    const encodedId = encodeBase62(`wf_${internalId}`);
  ...
  it('should handle slug IDs with multiple underscores', () => {
    const internalId = '6615943e7ace93b0540ae377';
    const encodedId = encodeBase62(`wf_${internalId}`);
