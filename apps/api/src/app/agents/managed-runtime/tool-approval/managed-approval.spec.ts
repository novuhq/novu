...
import { buildManagedApprovalCard } from './managed-approval';
...
describe('managed-approval', () => {
  describe('buildManagedApprovalCard — MCP tools', () => {
  ...
  describe('buildManagedApprovalCard — direct tools', () => {
