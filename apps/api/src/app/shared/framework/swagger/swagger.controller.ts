...
const options = new DocumentBuilder()
  ...
  .addTag(
    ...
    { url: 'https://docs.novu.co/subscribers/subscribers?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Topics',
    `Topics are a way to group subscribers together so that they can be notified of events at once. A topic is identified by a custom key. This can be helpful for things like sending out marketing emails or notifying users of new features. Topics can also be used to send notifications to the subscribers who have been grouped together based on their interests, location, activities and much more.`,
    { url: 'https://docs.novu.co/subscribers/topics?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Notification',
    ...
    { url: 'https://docs.novu.co/getting-started/introduction?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Integrations',
    `With the help of the Integration Store, you can easily integrate your favorite delivery provider. During the runtime of the API, the Integrations Store is responsible for storing the configurations of all the providers.`,
    { url: 'https://docs.novu.co/channels-and-providers/integration-store?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Layouts',
    ...
    { url: 'https://docs.novu.co/content-creation-design/layouts?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Workflows',
  ...
  .addTag(
    ...
    { url: 'https://docs.novu.co/platform/environments?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Inbound Parse',
    ...
    { url: 'https://docs.novu.co/platform/inbound-parse-webhook?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Feeds',
    ...
    { url: 'https://docs.novu.co/activity-feed?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Tenants',
    ...
    { url: 'https://docs.novu.co/tenants?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Messages',
    `A message in Novu represents a notification delivered to a recipient on a particular channel. Messages contain information about the request that triggered its delivery, a view of the data sent to the recipient, and a timeline of its lifecycle events. Learn more about messages.`,
    { url: 'https://docs.novu.co/workflows/messages?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Organizations',
    ...
    { url: 'https://docs.novu.co/platform/organizations?utm_campaign=inapp-swagger' }
  )
  .addTag(
    'Execution Details',
    ...
    { url: 'https://docs.novu.co/activity-feeds?utm_campaign=inapp-swagger' }
  )
  .build();
