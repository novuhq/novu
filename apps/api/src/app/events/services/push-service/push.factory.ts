...
import { APNSHandler, FCMHandler, ExpoHandler, PushwooshHandler } from './handlers';

export class PushFactory implements IPushFactory {
  handlers: IPushHandler[] = [new FCMHandler(), new ExpoHandler(), new APNSHandler(), new PushwooshHandler()];
