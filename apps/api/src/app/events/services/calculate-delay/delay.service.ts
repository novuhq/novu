...
export class DelayService {
  calculateDelay(step: NotificationStepEntity, payload: any, overrides: any): number {
    ...
    return this.toMilliseconds(step.metadata.amount as number, step.metadata.unit as DigestUnitEnum);
  }
