...
| `api.image.tag`                                       | Novu image tag (immutable tags are recommended)                                                                                                 | `0.14.0`                 |
...
| `worker.image.tag`                                       | Novu image tag (immutable tags are recommended)                                                                                                 | `0.14.0`             |
...
| `ws.image.tag`                                       | Novu image tag (immutable tags are recommended)                                                                                                 | `0.14.0`                 |
...
| `web.image.tag`                                       | Novu image tag (immutable tags are recommended)                                                                                                 | `0.14.0`                 |
